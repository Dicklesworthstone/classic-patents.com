# Provenance receipt: US 7,479,949 B2
...
- PDF page count: 364
- Printed claim count: 20 total, 3 independent (per catalogue record stats and reviewed ledger claims section)

## Facsimile map

The pinned PDF is the issued B2 document without a printed cover page: page 1 is already drawing-sheet matter.
