# Provenance Receipt — US 3,138,743 (Jack S. Kilby)

## Document Identity

- **Catalogue ID**: `us-3138743-kilby-integrated-circuit`
- **Patent Number**: US 3,138,743
- **Granted Title**: `MINIATURIZED ELECTRONIC CIRCUITS`
- **Short Title**: Jack Kilby Monolithic Integrated Circuit
- **Inventor**: Jack S. Kilby (Dallas, Texas)
- **Assignee**: Texas Instruments Incorporated (Dallas, Texas)
- **Filing Date**: February 6, 1959 (Serial No. 791,602)
- **Grant Date**: June 23, 1964
- **Primary Public Record URL**: `https://patents.google.com/patent/US3138743A/en`
- **Local Facsimile Path**: `public/patents/pdfs/us-3138743-kilby-integrated-circuit.pdf`
- **Rights Basis**: United States Patent Office public-domain record.
- **SHA-256 Digest**: `e523c17aaef78f727181d87c427be3edf10f964bed20b90ef07a8099a1c18eef`
- **PDF Page Count**: 9 pages

---

## Facsimile Map (cloud/PDF visual review, 2026-08-21)

| PDF Page | Physical Content | Status / Verification |
| :--- | :--- | :--- |
| **Page 1** | Drawing Sheet 1: Figures 1, 1a, 2, 2a, 3, 4, 5, and 5a. Visible numerals include 10, 10a, 10b, 11, 11a, 12, 12a, 13, 15, 15a, 16, 17, 17a, 18, 19, 20, 21, 22, 23, 25, 26, 27, 28, 29, 30, 35, 36, 37, 38, plus N, P, and N OR P. | Cloud/PDF visual review; old crops retained as research assets. |
| **Page 2** | Drawing Sheet 2: Figures 6a and 6b. Visible labels include T1, T2, R1–R8, C1–C4, INPUT-1, INPUT-2, OUTPUT-1, OUTPUT-2, +V, -V, GND., and 50, 51, 52, 53, 54, 56, 60, 70. | Cloud/PDF visual review; current public binding withheld. |
| **Page 3** | Drawing Sheet 3: Figure 7, the conventional multivibrator wiring diagram with T1, T2, R1–R8, C1, C2, resistor values, power rails, inputs, and outputs. | Cloud/PDF visual review; current public binding withheld. |
| **Page 4** | Drawing Sheet 4: Figures 8a, 8b, and 8c, the phase-shift oscillator and its two wiring presentations. No Figures 9–20 are printed in this grant. | Cloud/PDF text/image review; source-approved crop is still required before publication. |
...
The canonical record remains visitor-withheld. Direct cloud/PDF review confirms
that the grant ends at Claim 25, while the former ledger rewrote claims into
shorter, materially different language. Its former Claim 25 described hermetic
packaging; the printed Claim 25 limits Claim 24 to a P-N junction capacitor.
The former drawing-sheet entries also invented Figures 9–20. The replacement
edition now preserves the full specification sequence and exact claim literals
