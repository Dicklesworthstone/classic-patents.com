...
| p. 4 | Drawing sheet 4, Fig. 14 | Figure-sheet block; upright, signature-free apparatus crop `fig-14-source-crop-v4.png` plus separate printed-label crop `fig-14-label-source-crop-v4.png`; Fig. 14 references |
