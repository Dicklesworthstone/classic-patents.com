# Provenance Receipt — US 400,766 (Hall Aluminium Electrolysis)

## 1. Source Identity

- **Catalogue ID**: `us-400766-hall-aluminium`
- **Patent Number**: `US 400,766`
- **Granted Title**: `Process of Reducing Aluminium by Electrolysis`
- **Short Title**: `Hall-Héroult Aluminium Electrolytic Smelting Process`
- **Subtitle**: `Molten Cryolite Solvent Bath, Alumina Dissolution, and Continuous Carbon-Anode Electrodeposition`
- **Inventor**: `Charles M. Hall`
- **Inventor Location**: `Oberlin, Lorain County, Ohio`
- **Filing Date**: `1886-07-09` (July 9, 1886; Serial No. 207,601)
- **Grant Date**: `1889-04-02` (April 2, 1889)
- **Primary Public Record URL**: `https://patents.google.com/patent/US400766A/en`
- **Local PDF Facsimile**: `public/patents/pdfs/us-400766-hall-aluminium.pdf`
- **SHA-256 Digest**: `8a9cda34caaa0426bc62d75ca3910cab636c9f0329cb2f6193019c95c5d94791`
- **Page Count**: 3 pages
- **Rights Basis**: Public Domain United States Patent (US Government work published prior to 1928).
