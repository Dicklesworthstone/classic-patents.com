# Provenance Receipt — US 6,302,230 B1 (*Personal Mobility Vehicles and Methods*)

- **Catalogue ID**: `us-6302230-kamen-segway`
- **Granted Title**: *Personal Mobility Vehicles and Methods*
- **Inventors as Printed**: Dean L. Kamen (Bedford, NH), Robert R. Ambrogi (Manchester, NH), Robert J. Duggan (Northwood, NH), J. Douglas Field (Bedford, NH), Richard Kurt Heinzmann (Francestown, NH), Burl Amsbury (Cambridge, MA), Christopher C. Langenfeld (Nashua, NH)
- **Assignee**: DEKA Products Limited Partnership, Manchester, NH
- **Grant Date**: October 16, 2001 (`2001-10-16`)
- **Filing Date**: June 4, 1999 (`1999-06-04`)
- **Primary Public Record URL**: `https://patents.google.com/patent/US6302230B1/en`
- **Local Pinned PDF**: `public/patents/pdfs/us-6302230-kamen-segway.pdf`
- **Retrieval & Review Date**: September 1, 2026
- **Rights Basis**: Public-domain United States Patent document (historical text and drawing sheets)
- **Pinned Facsimile SHA-256**: `bcda272e161a0b973db9d64090f8102447e9aa35914a9a73e70a38736b7934db`
- **Facsimile Page Count**: 29 pages

---

## 29-Page Facsimile Map

| PDF Page | Facsimile Content | Review & Verification Notes |
| :--- | :--- | :--- |
