...
| --- | --- | --- |
| 1 | Drawing sheet: Fig. 1, Fig. 2, title, patent date, inventor and witness signatures | `figure-1.png`, `figure-2.png`; figure-sheet blocks in `pasteurFermentationEdition.ts` |
