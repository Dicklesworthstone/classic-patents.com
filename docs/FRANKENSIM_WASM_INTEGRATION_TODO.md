...
- `wasmArtifacts.test.ts` instantiates and steps all fourteen shipped packages. The thirteen dedicated boundaries prove typed WASM refusals; finite-field host decoders still fail closed on malformed accepted results.
