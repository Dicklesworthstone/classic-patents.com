...
- Next.js App Router Code-Splitting (Next.js build-reported first-load JS: 1.64 MB Home, 2.03 MB Detail, 1.70 MB Timeline; sub-200 kB initial transfer remains an active optimization target via dynamic imports and bundle slimming)
...
controls and telemetry buses now cover all 103 visual routes, and fourteen WASM
packages ship (12 active dedicated, 1 generic `fs-generic`, 1 dormant da Vinci),
but most default computation remains TypeScript. Generic WASM
