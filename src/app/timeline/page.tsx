...
export const metadata: Metadata = {
  ...
  description:
    "Interactive chronology of transformative patents from James Watt's steam engine and Samuel Hopkins' potash method to the Noyce silicon microchip, Apple II, and iPhone multi-touch.",
};
