 ...
 * for audit history. A separate, page-complete direct transcription is now
 * readable on the source face, while claim decoders, source-drawing annotations,
 * and the continuous edition remain unbound until their own review is complete.
 */
    ...
    pageAnchors: [
      {
        ...
        sourceRelationship: "Front-page identity block, abstract, and printed claim/figure count.",
      },
      {
        page: 2,
        exactSourceText: "FIG. 1.",
        sourceRelationship: "Printed drawing sheet 1 of 2, containing Figures 1 and 4.",
      },
      {
        page: 3,
        exactSourceText: "FIG. 2.",
        sourceRelationship: "Printed drawing sheet 2 of 2, containing Figures 2 and 3.",
      },
      {
        page: 4,
        exactSourceText: "This invention relates to mechanical manipulators",
        sourceRelationship:
          "Printed specification columns 1–2: background through preferred embodiment opening.",
      },
      {
        page: 5,
        exactSourceText: "shoulder 3 is rotatably mounted",
        sourceRelationship:
          "Printed specification columns 3–4: robot, forearm, wrist, and coupled shafts.",
      },
      {
        page: 6,
        exactSourceText: "spherical sector generated by the movement",
        sourceRelationship: "Printed specification columns 5–6 and issued claims 1–6.",
      },
      {
        page: 7,
        exactSourceText: "7. A manipulator as recited in claim 6",
        sourceRelationship: "Issued claims 7–18.",
      },
      {
        page: 8,
        exactSourceText: "Claim 1, line 19",
        sourceRelationship:
          "Certificate of correction preserving the printed claim and its correction separately.",
      },
    ],
  },
