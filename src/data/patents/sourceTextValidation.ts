 ...
 * reviewed-page marker. Keeping the marker in this pattern matters: a patent
 * citation followed by a standalone number can be actual source prose in the
 * middle of a ledger page, whereas this position is page furniture.
 */
