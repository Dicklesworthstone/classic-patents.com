  ...
  originalTextAsset: {
    ...
    pageAnchors: [
      ...
      },
      {
        page: 19,
        exactSourceText:
          "as well as to the article handled in case the moving parts of the machine encoun",
      ...
      },
      {
        page: 21,
        exactSourceText:
          "Vertical column B consists of a suitably shaped column member 134 (FIGS. 1, 2, 4",
        sourceRelationship: "Specification columns for page 21 of 31",
      },
      {
        page: 22,
        exactSourceText:
          "Rack 234 engages with a gear 246, the oscillation of which effects a horizontal ",
    ...
    },
    {
      ...
      callouts: [
        ...
        },
        {
          ...
          label: "Pinion",
          element: "334",
          description: "Pinion associated with one finger.",
          x: 42,
          y: 58,
        },
        {
