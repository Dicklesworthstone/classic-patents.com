...
export const baerOdysseyPatent: Patent = {
  ...
  originalTextAsset: {
    ...
    pageAnchors: [
      {
        page: 1,
        exactSourceText: "TELEVISION GAMING AND TRAINING",
        sourceRelationship: "grant front page and abstract",
      },
      {
        page: 2,
        exactSourceText: "SHEET 01 OF 11",
        sourceRelationship: "drawing sheet 1 of 11 (FIG. 1)",
      },
      {
        page: 3,
        exactSourceText: "SHEET 02 OF 11",
        sourceRelationship: "drawing sheet 2 of 11 (FIGS. 1A-1E)",
      },
      {
        page: 4,
        exactSourceText: "SHEET 03 OF 11",
        sourceRelationship: "drawing sheet 3 of 11 (FIGS. 2, 3)",
      },
      {
        page: 5,
        exactSourceText: "SHEET 04 OF 11",
        sourceRelationship: "drawing sheet 4 of 11 (FIG. 4)",
      },
      {
        page: 6,
        exactSourceText: "SHEET 05 OF 11",
        sourceRelationship: "drawing sheet 5 of 11 (FIGS. 5A-5C)",
      },
      {
        page: 7,
        exactSourceText: "SHEET 06 OF 11",
        sourceRelationship: "drawing sheet 6 of 11 (FIGS. 5D, 5E)",
      },
      {
        page: 8,
        exactSourceText: "SHEET 07 OF 11",
        sourceRelationship: "drawing sheet 7 of 11 (FIGS. 5F, 5G)",
      },
      {
        page: 9,
        exactSourceText: "SHEET 08 OF 11",
        sourceRelationship: "drawing sheet 8 of 11 (FIGS. 6A-6C)",
      },
      {
        page: 10,
        exactSourceText: "SHEET 09 OF 11",
        sourceRelationship: "drawing sheet 9 of 11 (FIGS. 6D-6F)",
      },
      {
        page: 11,
        exactSourceText: "SHEET 10 OF 11",
        sourceRelationship: "drawing sheet 10 of 11 (FIGS. 7, 8)",
      },
      {
        page: 12,
        exactSourceText: "SHEET 11 OF 11",
        sourceRelationship: "drawing sheet 11 of 11 (FIGS. 9, 10)",
      },
      {
        page: 13,
        exactSourceText: "Column 1",
        sourceRelationship: "specification columns 1 and 2",
      },
      {
        page: 14,
        exactSourceText: "Column 3",
        sourceRelationship: "specification columns 3 and 4",
      },
      {
        page: 15,
        exactSourceText: "Column 5",
        sourceRelationship: "specification columns 5 and 6",
      },
      {
        page: 16,
        exactSourceText: "Column 7",
        sourceRelationship: "specification columns 7 and 8",
      },
      {
        page: 17,
        exactSourceText: "Column 9",
        sourceRelationship: "specification columns 9 and 10",
      },
      {
        page: 18,
        exactSourceText: "Column 11",
        sourceRelationship: "specification columns 11 and 12",
      },
      {
        page: 19,
        exactSourceText: "Column 13",
        sourceRelationship: "specification columns 13 and 14",
      },
      {
        page: 20,
        exactSourceText: "Column 15",
        sourceRelationship: "specification columns 15 and 16",
      },
      {
        page: 21,
        exactSourceText: "Column 17",
        sourceRelationship: "claims columns 17 through 20",
      },
    ],
  },
