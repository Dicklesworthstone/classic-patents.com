...
export const ALL_COLORIZED_EQUATIONS: Record<string, ColorizedEquation[]> = {
  ...
  // Edwin Land Polaroid Instant Film & Rupturable Pod (US 2,543,181)
  "us-2543181-land-polaroid": [
    {
      id: "land-diffusion-transfer-flux",
      patentId: "us-2543181-land-polaroid",
      title: "Diffusion Transfer Reversal & Soluble Silver Thiosulfate Complex Flux",
      category: "Diffusion Kinetics & Catalyzed Physical Development",
      rawLatex:
        "J_{\\text{Ag}} = -D \\frac{\\partial C_{\\text{complex}}}{\\partial x} \\quad \\text{and} \\quad \\frac{d[\\text{Ag}^0]}{dt} = k_{\\text{cat}} S_{\\text{nuclei}} [\\text{Ag}(\\text{S}_2\\text{O}_3)_2^{3-}]",
      colorizedLatex:
        "\\textcolor{#059669}{J_{\\text{Ag}}} = -\\textcolor{#2563eb}{D} \\frac{\\partial \\textcolor{#d97706}{C_{\\text{complex}}}}{\\partial \\textcolor{#9333ea}{x}} \\quad \\text{and} \\quad \\textcolor{#dc2626}{\\frac{d[\\text{Ag}^0]}{dt}} = \\textcolor{#0d9488}{k_{\\text{cat}}} \\textcolor{#ea580c}{S_{\\text{nuclei}}} \\textcolor{#d97706}{[\\text{Ag}(\\text{S}_2\\text{O}_3)_2^{3-}]}",
      plainEnglishSentence: [
        { text: "The " },
        { text: "diffusion flux of soluble silver complex", variableId: "silver_flux" },
        { text: " across the viscous reagent layer scales with the " },
        { text: "diffusion coefficient", variableId: "diff_coeff" },
        { text: " and " },
        { text: "silver thiosulfate concentration gradient", variableId: "complex_conc" },
        { text: " over " },
        { text: "layer gap thickness", variableId: "layer_gap" },
        { text: ", driving the " },
        { text: "positive silver precipitation rate", variableId: "precip_rate" },
        { text: " catalyzed by " },
        { text: "catalytic reaction rate constant", variableId: "k_cat" },
        { text: " and " },
        { text: "catalytic nuclei surface area", variableId: "nuclei_area" },
        { text: "." },
      ],
      variables: [
        {
          id: "silver_flux",
          symbol: "J_{\\text{Ag}}",
          name: "Silver Complex Diffusion Flux",
          color: "emerald",
          role: "Rate of unexposed silver thiosulfate complex transport across viscous reagent layer to image receiver",
          unit: "Moles per square meter second (mol/(m^2 s))",
          dimension: "[N L^-2 T^-1]",
          explanation:
          ...
          telemetryMetricLabel: "Silver Ion Flux",
        },
        {
          id: "diff_coeff",
          symbol: "D",
          ...
          color: "sapphire",
          role: "Diffusivity of silver thiosulfate complex in viscous carboxymethyl cellulose alkaline gel ($D \\approx 2 \\times 10^{-10}\\text{ m}^2/\\text{s}$)",
          unit: "Square meters per second (m^2/s)",
          dimension: "[L^2 T^-1]",
          explanation:
            "Controlled by reagent viscosity and temperature, governing the 60-second completion time of image formation.",
        },
        {
          id: "complex_conc",
          symbol: "C_{\\text{complex}}",
          name: "Silver Thiosulfate Concentration",
          color: "amber",
          role: "Local concentration of $[\\text{Ag}(\\text{S}_2\\text{O}_3)_2]^{3-}$ complex ions in aqueous alkaline solution",
          unit: "Moles per cubic meter (mol/m^3)",
          dimension: "[N L^-3]",
          explanation:
            "Concentration is highest at unexposed negative areas and near zero at the positive reception layer where silver is deposited.",
        },
        {
          id: "layer_gap",
          symbol: "x",
          name: "Reagent Layer Thickness",
          color: "amethyst",
          role: "Physical spacing distance between negative emulsion and positive receiving sheet ($x \\approx 25\\ \\mu\\text{m}$)",
          unit: "Micrometers (um)",
          dimension: "[L]",
          explanation:
            "Precisely metered by camera steel squeegee rollers to provide short diffusion paths for rapid print development.",
        },
        {
          id: "precip_rate",
          symbol: "\\frac{d[\\text{Ag}^0]}{dt}",
          name: "Metallic Silver Precipitation Rate",
          color: "crimson",
          role: "Rate of formation of metallic silver reflection mirror image on the positive receiving sheet",
          unit: "Moles per cubic meter second (mol/(m^3 s))",
          dimension: "[N L^-3 T^-1]",
          explanation:
            "Developer reduces the dissolved silver complex upon contact with catalytic sulfide nuclei, creating a permanent positive visual print.",
        },
        {
          id: "k_cat",
          symbol: "k_{\\text{cat}}",
          name: "Heterogeneous Catalytic Rate Constant",
          color: "teal",
          role: "Specific catalytic rate coefficient on heavy metal sulfide nucleation sites",
          unit: "Cubic meters per mole second (m^3/(mol s))",
          dimension: "[L^3 N^-1 T^-1]",
          explanation:
            "Governs the speed of physical development at colloidal nuclei active sites.",
        },
        {
          id: "nuclei_area",
          symbol: "S_{\\text{nuclei}}",
          name: "Precipitation Nuclei Specific Surface Area",
          color: "coral",
          role: "Effective active surface area of sub-microscopic metallic sulfide precipitation centers ($2\\text{--}5\\text{ nm}$ CdS/Ag2S)",
          unit: "Square meters per cubic meter (m^2/m^3)",
          dimension: "[L^-1]",
          explanation:
            "Sub-microscopic heavy metal sulfide particles embedded in the positive sheet accelerate silver deposition to produce high optical density.",
        },
      ],
      pedagogicalNote:
      ...
      claimRef: 1,
      historicalSignificance:
        "The core chemical reaction mechanism of US Patent 2,543,181 that established the 60-second instant photography industry and Polaroid Corporation.",
    },
    {
      id: "land-hydrodynamic-nip-metering",
      patentId: "us-2543181-land-polaroid",
      title: "Hydrodynamic Squeegee Roller Metering & Pod Rupture Mechanics",
      category: "Elastohydrodynamics & Foil Container Mechanics",
      rawLatex:
        "h_{\\text{layer}} = 0.63 R \\left(\\frac{\\mu U}{F/L}\\right)^{2/3} \\quad \\text{and} \\quad P_{\\text{burst}} = \\frac{2 \\sigma_{\\text{seal}} t_{\\text{foil}}}{w_{\\text{pod}}}",
      colorizedLatex:
        "\\textcolor{#059669}{h_{\\text{layer}}} = 0.63 \\textcolor{#2563eb}{R} \\left(\\frac{\\textcolor{#d97706}{\\mu} \\textcolor{#9333ea}{U}}{\\textcolor{#dc2626}{F/L}}\\right)^{2/3} \\quad \\text{and} \\quad \\textcolor{#0d9488}{P_{\\text{burst}}} = \\frac{2 \\textcolor{#ea580c}{\\sigma_{\\text{seal}}} \\textcolor{#0891b2}{t_{\\text{foil}}}}{\\textcolor{#4f46e5}{w_{\\text{pod}}}}",
      plainEnglishSentence: [
        { text: "The metered " },
        { text: "reagent layer thickness", variableId: "layer_thickness" },
        { text: " spread between the film sheets scales with " },
        { text: "roller radius", variableId: "roller_radius" },
        { text: ", reagent " },
        { text: "viscosity", variableId: "viscosity" },
        { text: ", and " },
        { text: "pulling velocity", variableId: "pull_velocity" },
        { text: " over " },
        { text: "linear roller nip force", variableId: "nip_force" },
        { text: ", while the " },
        { text: "pod hydraulic burst pressure", variableId: "burst_pressure" },
        { text: " depends on " },
        { text: "seal tensile bond strength", variableId: "seal_strength" },
        { text: ", " },
        { text: "foil thickness", variableId: "foil_thickness" },
        { text: ", and " },
        { text: "pod cavity width", variableId: "pod_width" },
        { text: "." },
      ],
      variables: [
        {
          id: "layer_thickness",
          symbol: "h_{\\text{layer}}",
          name: "Metered Reagent Layer Thickness",
          color: "emerald",
          role: "Uniform viscous chemical gel coating thickness between negative and positive sheets ($h \\approx 25\\ \\mu\\text{m}$)",
          unit: "Micrometers (um)",
          dimension: "[L]",
          explanation:
          ...
          telemetryMetricLabel: "Liquid Layer Thickness",
        },
        {
          id: "roller_radius",
          symbol: "R",
          name: "Nip Roller Radius",
          color: "sapphire",
          role: "Effective radius of precision stainless-steel camera squeegee rollers ($R \\approx 4\\text{ mm}$)",
          unit: "Millimeters (mm)",
          dimension: "[L]",
          explanation:
            "Determines the hydrodynamic entry wedge geometry for spreading viscous liquid across moving film webs.",
        },
        {
          id: "viscosity",
          symbol: "\\mu",
          name: "Reagent Dynamic Viscosity",
          color: "amber",
          role: "Viscosity of carboxymethyl cellulose aqueous developer solution ($\\mu \\approx 10\\text{ to }200\\text{ Pa}\\cdot\\text{s}$ at $24^\\circ\\text{C}$)",
          unit: "Pascal-seconds (Pa s)",
          dimension: "[M L^-1 T^-1]",
          explanation:
            "High viscosity prevents dripping and spillage while ensuring laminar spreading under roller pressure.",
        },
        {
          id: "pull_velocity",
          symbol: "U",
          name: "Film Tab Pulling Velocity",
          color: "amethyst",
          role: "Manual or motorized tab extraction speed through camera exit rollers ($U \\approx 0.1\\text{--}0.3\\text{ m/s}$)",
          unit: "Meters per second (m/s)",
          dimension: "[L T^-1]",
          explanation:
            "The speed at which the user draws the film packet through the squeegee rollers.",
        },
        {
          id: "nip_force",
          symbol: "F/L",
          name: "Linear Nip Clamping Force",
          color: "crimson",
          role: "Spring-loaded clamping force per unit roller width ($F/L \\approx 150\\text{ N/m}$)",
          unit: "Newtons per meter (N/m)",
          dimension: "[M T^-2]",
          explanation:
            "Maintains calibrated pressure across the web to meter a uniform microscopic reagent layer.",
        },
        {
          id: "burst_pressure",
          symbol: "P_{\\text{burst}}",
          name: "Pod Rupture Burst Pressure",
          color: "teal",
          role: "Hydraulic pressure required to unseal the leading lip of the frangible reagent container ($P_{\\text{burst}} \\approx 350\\text{ kPa}$)",
          unit: "Kilopascals (kPa)",
          dimension: "[M L^-1 T^-2]",
          explanation:
            "The weakened marginal seal of the pod unseals cleanly under roller pressure, releasing liquid into the entering film nip without tearing outer foil walls.",
        },
        {
          id: "seal_strength",
          symbol: "\\sigma_{\\text{seal}}",
          name: "Adhesive Seal Peel Strength",
          color: "coral",
          role: "Tensile bond strength of the frangible thermoplastic marginal seal lining",
          unit: "Newtons per square meter (N/m^2)",
          dimension: "[M L^-1 T^-2]",
          explanation:
            "Engineered to peel open at lower tensile stress than the burst strength of the outer metal foil laminate.",
        },
        {
          id: "foil_thickness",
          symbol: "t_{\\text{foil}}",
          name: "Metal Foil Wall Thickness",
          color: "cyan",
          role: "Thickness of deformable oxygen- and water-vapor-impervious aluminum barrier foil ($t \\approx 50\\ \\mu\\text{m}$)",
          unit: "Micrometers (um)",
          dimension: "[L]",
          explanation:
            "Provides a hermetic barrier preventing reagent oxidation and water loss during years of film shelf storage.",
        },
        {
          id: "pod_width",
          symbol: "w_{\\text{pod}}",
          name: "Pod Internal Cavity Width",
          color: "amethyst",
          role: "Transverse width of rupturable pod container matching film frame aperture width",
          unit: "Millimeters (mm)",
          dimension: "[L]",
          explanation:
            "Spans the entire picture format width to discharge a uniform transverse chemical wave across the film.",
        },
      ],
      pedagogicalNote:
      ...
      claimRef: 1,
      historicalSignificance:
        "Protects the disposable, single-use rupturable reagent pod that made instant photography possible without liquid bottles or darkroom chemicals.",
    },
  ],
  ...
  "us-586193-marconi-radio": [
    {
      id: "marconi-source-contact-reset",
      patentId: "us-586193-marconi-radio",
      title: "Claim 1: Imperfect Electrical Contact and Shaking Means",
      category: "Source-Bound Electrical Signalling",
      rawLatex:
        "\\text{imperfect electrical contact} + \\text{circuit through contact} + \\text{shaking means} \\rightarrow \\text{resettable received-oscillation signal}",
      colorizedLatex:
        "\\textcolor{#059669}{\\text{imperfect electrical contact}} + \\textcolor{#2563eb}{\\text{circuit through contact}} + \\textcolor{#d97706}{\\text{shaking means}} \\rightarrow \\textcolor{#9333ea}{\\text{resettable received-oscillation signal}}",
      plainEnglishSentence: [
        { text: "Claim 1 combines an " },
        { text: "imperfect electrical contact", variableId: "contact" },
        { text: " with a " },
        { text: "circuit through that contact", variableId: "local_circuit" },
        { text: " and " },
        { text: "means actuated by the circuit for shaking it", variableId: "reset" },
        { text: " after reception of electrical oscillations." },
      ],
      variables: [
        {
          id: "contact",
          symbol: "contact",
          name: "Imperfect electrical contact",
          color: "emerald",
          role: "The receiver element named by Claim 1, whose electrical state responds to received oscillations.",
          unit: "Claim 1 receiver element",
          dimension: "variable-resistance contact",
          explanation:
        ...
        },
        {
          id: "local_circuit",
          symbol: "circuit",
          name: "Circuit through the contact",
          color: "sapphire",
          role: "The circuit expressly connected through the imperfect contact in Claim 1.",
          unit: "Claim 1 circuit relation",
          dimension: "local signalling circuit",
          explanation:
            "This is a topological claim relation, not a stated voltage, current, frequency, or power measurement.",
        },
        {
          id: "reset",
          symbol: "shaking means",
          name: "Circuit-actuated shaking means",
          color: "amber",
          role: "The means actuated by the contact circuit to shake the contact after it has responded.",
          unit: "Claim 1 reset relation",
          dimension: "electromechanical recovery",
          explanation:
            "The reset is a named element of the claimed receiver arrangement. The pending independent source review does not support treating it as a quantified or modern RF-detector model.",
        },
      ],
      pedagogicalNote:
      ...
      claimRef: 1,
      historicalSignificance:
        "The card directs attention to a legal receiver-and-recovery combination printed in the grant rather than later radio-system performance claims.",
    },
  ],
  ...
  // 22. Carl Linde: source-bounded companion to US 727,650
  "us-727650-linde-air-liquefaction": [
    {
      id: "linde-joule-thomson-liquefaction",
      patentId: "us-727650-linde-air-liquefaction",
      title: "The temperature-drop relation printed in US 727,650",
      ...
      plainEnglishSentence: [
        ...
        { text: "T − T′", variableId: "temp" },
        { text: " is related to the difference between the " },
        { text: "higher pressure p²", variableId: "press" },
        { text: " and the " },
        { text: "lower pressure p′", variableId: "low_press" },
        {
          text: ". Linde gives a 75-atmosphere / 25-atmosphere example and uses the returning stream in G′ to make successive cooling possible.",
        },
      ],
      variables: [
        {
          id: "temp",
          symbol: "T - T'",
          name: "Printed temperature decrease",
          color: "emerald",
          role: "The temperature decrease named by the printed relation; the grant tabulates several values for a fifty-atmosphere difference.",
        ...
        },
        {
          ...
          color: "sapphire",
          role: "Higher pressure in Linde’s notation. His stated air-liquefaction example uses seventy-five atmospheres.",
          unit: "Atmospheres",
          dimension: "[M L^-1 T^-2]",
          explanation:
            "Compressor C sends air through cooler K and the inner channel of G′ to regulating valve R′.",
          telemetryMetricLabel: "High-pressure example",
        },
        {
          id: "low_press",
          symbol: "p'",
          name: "Lower pressure",
          color: "amethyst",
          role: "Lower-pressure space in Linde’s notation. His stated example uses twenty-five atmospheres.",
          unit: "Atmospheres",
          dimension: "[M L^-1 T^-2]",
          explanation:
            "Gas returning through the annular channel of G′ travels at this lower pressure toward compressor C.",
          telemetryMetricLabel: "Low-pressure example",
        },
      ],
      pedagogicalNote:
      ...
      claimRef: 1,
      historicalSignificance:
        "Claim 1 covers compression, cooling, expansion into a lower-pressure space, and using the expanded cold gas to absorb heat from gas about to expand.",
    },
    {
      ...
      variables: [
        {
          ...
          color: "amethyst",
          role: "The lower-pressure stream returns through the annular channel of G′ to the suction end of C.",
        ...
        },
        {
          ...
          color: "crimson",
          role: "The high-pressure stream leaves C, is cooled in K, and travels through the inner channel of G′ to R′.",
          unit: "Not quantified in the grant",
          dimension: "[L^2 T^-2]",
          explanation:
    ...
    },
    {
      ...
      patentId: "us-727650-linde-air-liquefaction",
      title: "Second-law reference, not a reported Linde plant measurement",
      ...
      variables: [
        {
          ...
          color: "emerald",
          role: "A modern thermodynamic reference quantity. US 727,650 does not report work per unit mass.",
          unit: "Not quantified in the grant",
          dimension: "[L^2 T^-2]",
          explanation:
        ...
        },
        {
          ...
          color: "sapphire",
          role: "An environmental boundary in a modern reference calculation; the source only says K may use cold brine or liquid ammonia.",
          unit: "Kelvin (K)",
          dimension: "[\\Theta]",
          explanation: "The patent does not give a cooling-water temperature.",
        },
        {
          id: "s_0",
          symbol: "s_0",
          ...
          color: "amber",
          role: "A modern state-property symbol; no source value is supplied.",
          unit: "Not quantified in the grant",
          dimension: "[L^2 T^-2 \\Theta^-1]",
          explanation:
            "This card provides terminology only and does not infer a state point from the patent.",
        },
        {
          id: "s_liq",
          ...
          color: "cyan",
          role: "A modern state-property symbol for the condensed portion described in V′.",
          unit: "Not quantified in the grant",
          dimension: "[L^2 T^-2 \\Theta^-1]",
          explanation:
            "US 727,650 states that air liquefies and collects in V′, without a numerical state point.",
        },
        {
          id: "h_0",
          symbol: "h_0",
          ...
          color: "crimson",
          role: "A modern state-property symbol for the incoming air.",
          unit: "Not quantified in the grant",
          dimension: "[L^2 T^-2]",
          explanation:
            "The source identifies the path from compressor P to C but gives no enthalpy value.",
        },
        {
          id: "h_liq",
          ...
          color: "amethyst",
          role: "A modern state-property symbol for the condensed portion in V′.",
          unit: "Not quantified in the grant",
          dimension: "[L^2 T^-2]",
          explanation: "No numerical liquid-air enthalpy is printed in US 727,650.",
        },
      ],
      pedagogicalNote:
      ...
      claimRef: 1,
      historicalSignificance:
        "The source claims a process of producing low temperatures, liquefying gases, and separating gaseous mixtures; it does not state a minimum-work result.",
    },
  ],
  ...
  "us-124404-westinghouse-air-brake": [
    {
      id: "westinghouse-double-pipe-receiver-expansion",
      patentId: "us-124404-westinghouse-air-brake",
      title: "Auxiliary Air-Receiver Expansion & Automatic Cylinder Charging (Claims 1 & 4)",
      category: "Pneumatics & Railroad Braking",
      rawLatex: "P_{\\text{cyl}} = P_D \\cdot \\left( \\frac{V_D}{V_D + V_C} \\right)",
      colorizedLatex:
        "\\textcolor{#059669}{P_{\\text{cyl}}} = \\textcolor{#2563eb}{P_D} \\cdot \\left( \\frac{\\textcolor{#9333ea}{V_D}}{\\textcolor{#9333ea}{V_D} + \\textcolor{#0891b2}{V_C}} \\right)",
      plainEnglishSentence: [
        {
          text: "The ",
        },
        {
          text: "brake cylinder pneumatic pressure",
          variableId: "p_cyl",
        },
        {
          text: " achieved upon tripping automatic cock e equals the ",
        },
        {
          text: "stored auxiliary air-receiver pressure",
          variableId: "p_d",
        },
        {
          text: " multiplied by the expansion ratio of ",
        },
        {
        ...
        {
          text: " to total combined ",
        },
        {
          text: "brake cylinder displacement volume",
          variableId: "v_c",
        },
        {
          text: " plus receiver volume.",
        },
      ],
      variables: [
        {
          id: "p_cyl",
          symbol: "P_{\\text{cyl}}",
          name: "Brake Cylinder Actuation Pressure",
          color: "emerald",
          role: "Pneumatic pressure delivered to brake cylinder C when cock e trips ($50 - 70\\text{ psi}$)",
          ...
          telemetryMetricLabel: "Brake Cylinder Pressure (C)",
        },
        {
          id: "p_d",
          symbol: "P_D",
          name: "Auxiliary Air-Receiver Stored Pressure",
          color: "sapphire",
          role: "Compressed air pressure stored in car auxiliary receiver D ($80 - 100\\text{ psi}$)",
          unit: "Pounds per square inch (psi)",
          dimension: "[M L^-1 T^-2]",
          explanation: "Charged continuously from the locomotive via charging pipe B¹ and cock d¹.",
        },
        {
          id: "v_d",
          symbol: "V_D",
          name: "Auxiliary Receiver Volume",
          color: "amethyst",
          role: "Internal volume of cylindrical reservoir tank D mounted under each car ($~40\\text{ liters}$)",
          unit: "liters or m^3",
          dimension: "[L^3]",
          explanation: "Provides dedicated local pneumatic energy on every individual railcar.",
        },
        {
          id: "v_c",
          symbol: "V_C",
          ...
          color: "cyan",
          role: "Internal volume of brake cylinder C at full piston stroke ($~15\\text{ liters}$)",
          unit: "liters or m^3",
          dimension: "[L^3]",
          explanation: "Receives expanding air from tank D to drive the brake push-rod.",
        },
      ],
      pedagogicalNote:
      ...
      claimRef: 1,
      historicalSignificance:
        "US 124,404 introduced local car-mounted stored air reservoirs and automatic trip mechanisms, establishing the architecture of fail-safe automatic train braking.",
    },
    {
      id: "westinghouse-pneumatic-signalling-index",
      patentId: "us-124404-westinghouse-air-brake",
      title: "Pneumatic Signalling Pressure Differential & Graduated Index Deflection (Claim 5)",
      category: "Pneumatics & Railroad Safety Mechanics",
      rawLatex:
        "N_{\\text{signal}} = 1 + \\left\\lfloor \\frac{\\Delta P_{\\text{pulse}}}{\\Delta P_{\\text{step}}} \\right\\rfloor",
      colorizedLatex:
        "\\textcolor{#059669}{N_{\\text{signal}}} = 1 + \\left\\lfloor \\frac{\\textcolor{#2563eb}{\\Delta P_{\\text{pulse}}}}{\\textcolor{#ea580c}{\\Delta P_{\\text{step}}}} \\right\\rfloor",
      plainEnglishSentence: [
        { text: "The " },
        { text: "graduated signal index position (1 to 5)", variableId: "n_signal" },
        {
          text: " indicated on gauge dial g² equals the base clear position plus the quotient of ",
        },
        { text: "pneumatic pulse pressure differential", variableId: "delta_p_pulse" },
        { text: " over the " },
        { text: "index calibration step increment", variableId: "delta_p_step" },
        {
          text: ", transmitting discrete coded orders between conductor and engineer through signal pipes n, n¹.",
        },
      ],
      variables: [
        {
          id: "n_signal",
          symbol: "N_{\\text{signal}}",
          name: "Graduated Index Dial Position",
          color: "emerald",
          role: "Integer signal position on dial g²: 1 (clear), 2 (flag station), 3 (stop for orders), 4 (danger slow), 5 (danger stop)",
          unit: "Dial position index (1-5)",
          dimension: "[1]",
          explanation:
            "Gives the locomotive engineer clear visual orders corresponding to whistle blasts.",
          telemetryMetricLabel: "Signalling Index (Fig. 4)",
        },
        {
          id: "delta_p_pulse",
          symbol: "\\Delta P_{\\text{pulse}}",
          name: "Pneumatic Signal Pulse Differential",
          color: "sapphire",
          role: "Pressure drop or pulse induced across pipes n, n¹ when conductor turns cock n² ($0 - 2.5\\text{ psi}$)",
          unit: "psi",
          dimension: "[M L^-1 T^-2]",
          explanation: "Flows through signal pipe loop to deflect the spring-loaded gauge needle.",
        },
        {
          id: "delta_p_step",
          symbol: "\\Delta P_{\\text{step}}",
          name: "Calibration Step Increment",
          color: "coral",
          role: "Pressure increment required to advance the dial pointer by one graduation ($0.5\\text{ psi/step}$)",
          unit: "psi / graduation",
          dimension: "[M L^-1 T^-2]",
          explanation: "Calibrated spring tension behind the dial mechanism.",
        },
      ],
      pedagogicalNote:
      ...
      claimRef: 5,
      historicalSignificance:
        "Integrated train-wide communication into the pneumatic braking circuit, establishing modern railway signalling controls.",
    },
  ],
  ...
  "_legacy-unpublished-us-200521-edison-phonograph": [
    ...
    },
    {
      ...
      patentId: "us-200521-edison-phonograph",
      title: "Source-Specified Helical Groove and Threaded-Shaft Pitch",
      category: "Acoustics & Sound Recording",
      rawLatex: "g = 10\\,\\text{grooves/in} \\quad \\text{and} \\quad s = 10\\,\\text{threads/in}",
      colorizedLatex:
        "\\textcolor{#059669}{g} = 10\\,\\text{grooves/in} \\quad \\text{and} \\quad \\textcolor{#2563eb}{s} = 10\\,\\text{threads/in}",
      plainEnglishSentence: [
        { text: "The " },
        { text: "helical groove on cylinder A", variableId: "groove_pitch" },
        { text: " is stated as ten grooves to the inch, and shaft X has " },
        { text: "matching thread pitch", variableId: "thread_pitch" },
        {
          text: " of ten threads to the inch. As the cylinder turns and advances, a diaphragm's hard point records vibration marks in foil or another yielding material.",
        },
      ],
      variables: [
        {
          id: "groove_pitch",
          symbol: "g",
          name: "Source Helical-Groove Pitch",
          color: "emerald",
          role: "Cylinder A has a helical indenting groove cut from end to end, stated as ten grooves to the inch.",
          unit: "grooves/in",
          dimension: "[L^-1]",
          explanation:
            "This is a printed value for the illustrated cylinder. The specification puts metallic foil, paper, or another yielding material over that grooved surface.",
        },
        {
          id: "thread_pitch",
          symbol: "s",
          name: "Source Shaft-Thread Pitch",
          color: "sapphire",
          role: "Shaft X and bearing P are stated as having ten threads to the inch.",
          unit: "threads/in",
          dimension: "[L^-1]",
          explanation:
            "The matching screw action lets cylinder A travel endwise while it rotates. The grant names clock-work M or another power source, but supplies no rotation rate.",
        },
      ],
      pedagogicalNote:
        "The source gives a mechanical sequence, not an acoustic calibration: words vibrate a diaphragm, the hard point indents a yielding record, and a second point and diaphragm later recover motion from the marks. It prints no diaphragm material, cylinder size, hand-crank, rotation rate, indentation depth, or bandwidth.",
      claimRef: 4,
      historicalSignificance:
        "Claim 4 covers the cylinder form in which a drive revolves a helically grooved cylinder and gives it the matching end movement. Claims 1 through 3 separately state the record-and-reproduction combinations.",
    },
  ],
  ...
  // Linus Yale Jr. Pin-Tumbler Cylinder Lock & Flat Bitted Key (US 48,475)
  "us-48475-yale-lock": [
    {
      id: "yale-shear-line-kinematics",
      patentId: "us-48475-yale-lock",
      title: "Pin-Tumbler Shear-Line Boundary Condition & Alignment Kinematics",
      category: "Precision Mechanics & Cryptographic Locks",
      rawLatex:
        "\\Delta y_i = |y_{\\text{bitting},i} + L_{\\text{keypin},i} - R_{\\text{plug}}| \\le \\delta_{\\text{shear}}",
      colorizedLatex:
        "\\textcolor{#dc2626}{\\Delta y_i} = |\\textcolor{#2563eb}{y_{\\text{bitting},i}} + \\textcolor{#059669}{L_{\\text{keypin},i}} - \\textcolor{#d97706}{R_{\\text{plug}}}| \\le \\textcolor{#9333ea}{\\delta_{\\text{shear}}}",
      plainEnglishSentence: [
        { text: "The " },
        { text: "pin shear error", variableId: "delta_y" },
        { text: " equals the absolute difference between the " },
        { text: "key bitting lift", variableId: "y_bit" },
        { text: " plus " },
        { text: "key pin length", variableId: "l_pin" },
        { text: " and the " },
        { text: "plug radius", variableId: "r_plug" },
        { text: ", which must remain within the " },
        { text: "machining clearance tolerance", variableId: "delta_tol" },
        { text: " for the cylinder to rotate." },
      ],
      variables: [
        {
          id: "delta_y",
          symbol: "\\Delta y_i",
          name: "Pin Shear Line Alignment Error",
          color: "crimson",
          role: "Distance between the pin parting line and the outer cylinder shear boundary ($< 0.09\\text{ mm}$)",
          unit: "Millimeters (mm)",
          dimension: "[L]",
          explanation:
            "If any single pin has an error exceeding tolerance, it physically spans the shear line and mechanically blocks rotation.",
          telemetryKey: "maxShearErrorMm",
        },
        {
          id: "y_bit",
          symbol: "y_{\\text{bitting},i}",
          name: "Key Blade Bitting Height",
          color: "sapphire",
          role: "Height of the serrated bottom notch on the flat sheet steel key ($2.0\\text{ to }6.5\\text{ mm}$)",
          unit: "Millimeters (mm)",
          dimension: "[L]",
          explanation:
            "Each notch directly lifts its corresponding bottom pin against the downward force of its helical spring.",
          telemetryKey: "keyInsertion",
        },
        {
          id: "l_pin",
          symbol: "L_{\\text{keypin},i}",
          name: "Bottom Key Pin Length",
          color: "emerald",
          role: "Machined length of the lower pin that rests directly upon the key blade",
          unit: "Millimeters (mm)",
          dimension: "[L]",
          explanation:
            "Complementary to the driver pin; varied across the 5 chambers to create unique key combinations.",
        },
        {
          id: "r_plug",
          symbol: "R_{\\text{plug}}",
          name: "Rotating Plug Radius",
          color: "amber",
          role: "Cylindrical radius of the inner revolving core ($R_{\\text{plug}} = 6.35\\text{ mm} = 0.25\\text{ in}$)",
          unit: "Millimeters (mm)",
          dimension: "[L]",
          explanation:
            "Defines the exact radial shear boundary separating the rotating plug from the stationary outer shell.",
        },
        {
          id: "delta_tol",
          symbol: "\\delta_{\\text{shear}}",
          name: "Machining Shear Tolerance",
          color: "amethyst",
          role: "Maximum allowable mechanical clearance ($0.08\\text{ to }0.10\\text{ mm}$)",
          unit: "Millimeters (mm)",
          dimension: "[L]",
          explanation:
            "Tighter tolerances increase picking security while demanding higher precision machining.",
        },
      ],
      pedagogicalNote:
      ...
      claimRef: 4,
      historicalSignificance:
        "US 48,475 established the modern pin-tumbler cylinder lock and small flat bitted key, making heavy, bulky Victorian bit keys obsolete and becoming the universal security standard worldwide.",
    },
    {
      id: "yale-spring-force-torque",
      patentId: "us-48475-yale-lock",
      title: "Hooke's Law Spring Dynamics & Shear Binding Torque",
      category: "Solid Mechanics & Friction Dynamics",
      rawLatex:
      ...
      colorizedLatex:
        "\\textcolor{#059669}{F_s} = \\sum_{i=1}^5 \\textcolor{#2563eb}{k_s} \\textcolor{#ea580c}{\\Delta x_i} \\quad \\text{and} \\quad \\textcolor{#9333ea}{\\tau_{\\text{net}}} = \\textcolor{#d97706}{\\tau_{\\text{applied}}} - \\sum_{i=1}^5 \\textcolor{#dc2626}{\\mu_s} \\frac{\\textcolor{#d97706}{\\tau_{\\text{applied}}}}{\\textcolor{#0891b2}{R_{\\text{plug}}}} [1 - \\Theta(\\textcolor{#059669}{\\delta_{\\text{tol}}} - \\textcolor{#dc2626}{\\Delta y_i})]",
      plainEnglishSentence: [
        { text: "The " },
        { text: "total spring restoration force", variableId: "f_spring" },
        { text: " depends on the " },
        { text: "pin spring stiffness", variableId: "k_spring" },
        { text: " and " },
        { text: "spring compression", variableId: "dx_spring" },
        { text: ", while " },
        { text: "net turning torque", variableId: "tau_net" },
        { text: " equals " },
        { text: "applied torque", variableId: "tau_app" },
        { text: " minus " },
        { text: "shear binding friction", variableId: "mu_fric" },
        { text: " whenever pins cross the shear boundary." },
      ],
      variables: [
        {
          id: "f_spring",
          symbol: "F_s",
          name: "Total Spring Restorative Force",
          color: "emerald",
          role: "Sum of downward forces exerted by all 5 pin compression springs ($2.5\\text{ to }5.0\\text{ N}$)",
          unit: "Newtons (N)",
          dimension: "[M L T^-2]",
          explanation:
            "Continuously pushes driver pins across the shear line when the key is withdrawn.",
          telemetryKey: "totalSpringForceN",
        },
        {
          id: "k_spring",
          symbol: "k_s",
          name: "Tumbler Spring Constant",
          color: "sapphire",
          role: "Stiffness of each small phosphor-bronze or steel compression spring ($k_s \\approx 140\\text{ N/m}$)",
          unit: "Newtons / meter (N/m)",
          dimension: "[M T^-2]",
          explanation:
            "Provides smooth, tactile key insertion resistance and rapid snap-back upon key extraction.",
        },
        {
          id: "dx_spring",
          symbol: "\\Delta x_i",
          ...
          color: "coral",
          role: "Compression distance of spring $i$ inside the upper cylinder chamber ($1.0\\text{ to }4.0\\text{ mm}$)",
          unit: "Millimeters (mm)",
          dimension: "[L]",
          explanation: "Varies dynamically as the key blade slides into the keyway.",
        },
        {
          id: "tau_net",
          symbol: "\\tau_{\\text{net}}",
          name: "Net Rotational Plug Torque",
          color: "amethyst",
          role: "Available torque to rotate the plug, throw the deadbolt, and retract talons ($0.0\\text{ to }0.3\\text{ N}\\cdot\\text{m}$)",
          unit: "Newton-meters (N*m)",
          dimension: "[M L^2 T^-2]",
          explanation:
            "Equals zero when pins bind; rises immediately to drive the deadbolt when all pins clear shear.",
          telemetryKey: "appliedTorqueNm",
        },
        {
          id: "tau_app",
          symbol: "\\tau_{\\text{applied}}",
          name: "Applied User Turning Torque",
          color: "amber",
          role: "Rotational torque applied by the user twisting the key bow ($0.1\\text{ to }0.4\\text{ N}\\cdot\\text{m}$)",
          unit: "Newton-meters (N*m)",
          dimension: "[M L^2 T^-2]",
          explanation: "Transmitted through the thin steel key blade into the plug keyway walls.",
          telemetryKey: "appliedTorqueNm",
        },
        {
          id: "mu_fric",
          symbol: "\\mu_s",
          name: "Pin-to-Housing Friction Coefficient",
          color: "crimson",
          role: "Static friction coefficient between brass pins and the cylinder housing bore ($\\mu_s \\approx 0.35\\text{ to }0.45$)",
          unit: "Dimensionless",
          dimension: "[1]",
          explanation:
            "Under rotational tension, misaligned pins bind against chamber walls, preventing picking.",
        },
      ],
      pedagogicalNote:
      ...
      claimRef: 4,
      historicalSignificance:
        "The Yale lock combined high spring reliability, anti-pick serrations, and extreme physical compactness in a single mass-manufacturable brass cylinder.",
    },
  ],
  ...
  // Alexander Graham Bell & Charles Sumner Tainter Photophone (US 235,199)
  "us-235199-bell-photophone": [
    {
      id: "photophone-optical-flux-modulation",
      patentId: "us-235199-bell-photophone",
      title: "Voice Diaphragm Beam Divergence Modulation & Free-Space Optical Transmission",
      category: "Free-Space Optical Communications & Wave Optics",
      rawLatex:
        "E_{\\text{recv}}(t) = \\frac{P_0 [1 + m \\sin(2\\pi f t)] \\cdot e^{-\\alpha d}}{\\frac{\\pi}{4} [D_0 + 2 d \\tan(\\theta_{\\text{div}}/2)]^2}",
      colorizedLatex:
        "\\textcolor{#dc2626}{E_{\\text{recv}}(t)} = \\frac{\\textcolor{#2563eb}{P_0} [1 + \\textcolor{#d97706}{m} \\sin(2\\pi f t)] \\cdot \\textcolor{#059669}{e^{-\\alpha d}}}{\\frac{\\pi}{4} [\\textcolor{#0891b2}{D_0} + 2 \\textcolor{#9333ea}{d} \\tan(\\textcolor{#ea580c}{\\theta_{\\text{div}}}/2)]^2}",
      plainEnglishSentence: [
        { text: "The " },
        { text: "received optical irradiance", variableId: "e_recv" },
        { text: " delivered to the distant parabolic collector depends on the " },
        { text: "collected source power", variableId: "p_source" },
        { text: " modulated by " },
        { text: "vocal acoustic depth", variableId: "m_mod" },
        { text: ", attenuated by " },
        { text: "atmospheric extinction", variableId: "t_atm" },
        { text: " across " },
        { text: "wireless distance", variableId: "d_link" },
        { text: ", and spread by " },
        { text: "diaphragm beam divergence", variableId: "theta_div" },
        { text: "." },
      ],
      variables: [
        {
          id: "e_recv",
          symbol: "E_{\\text{recv}}(t)",
          name: "Received Optical Irradiance",
          color: "crimson",
          role: "Instantaneous optical flux density reaching the receiving aperture ($0.1\\text{ to }5.0\\text{ W/m}^2$)",
          unit: "Watts / meter squared (W/m^2)",
          dimension: "[M T^-3]",
          explanation:
            "Vibrates in direct synchronism with speech sound pressure waves hitting the transmitter diaphragm.",
          telemetryKey: "solarIrradianceWPerM2",
        },
        {
          id: "p_source",
          symbol: "P_0",
          name: "Collected Source Beam Power",
          color: "sapphire",
          role: "Total radiant power collected from the heliostat mirror or artificial arc light ($5.0\\text{ to }15.0\\text{ W}$)",
          unit: "Watts (W)",
          dimension: "[M L^2 T^-3]",
          explanation:
            "Concentrated onto the thin silvered mirror diaphragm by the primary condensing lens.",
        },
        {
          id: "m_mod",
          symbol: "m",
          name: "Vocal Optical Modulation Index",
          color: "amber",
          role: "Modulation depth imparted by acoustic diaphragm vibration ($0.15\\text{ to }0.85$)",
          unit: "Dimensionless fraction",
          dimension: "[1]",
          explanation:
            "Proportional to vocal acoustic sound pressure level at the transmitter mouthpiece.",
          telemetryKey: "voiceSplDb",
        },
        {
          id: "t_atm",
          symbol: "e^{-\\alpha d}",
          name: "Atmospheric Transmission Factor",
          color: "emerald",
          role: "Beer-Lambert atmospheric transmission efficiency in clear air ($> 95\\%$ at $213\\text{ m}$)",
          unit: "Dimensionless fraction",
          dimension: "[1]",
          explanation:
            "Accounts for Rayleigh scattering and particulate absorption along the free-space optical path.",
        },
        {
          id: "d_link",
          symbol: "d",
          name: "Free-Space Wireless Distance",
          color: "amethyst",
          role: "Optical transmission baseline between transmitting and receiving stations ($10\\text{ to }500\\text{ m}$)",
          unit: "Meters (m)",
          dimension: "[L]",
          explanation:
            "Bell and Tainter successfully transmitted speech 213 meters between the Franklin School and their laboratory on June 3, 1880.",
          telemetryKey: "transmissionDistanceM",
        },
        {
          id: "theta_div",
          symbol: "\\theta_{\\text{div}}",
          name: "Beam Divergence Angle",
          color: "coral",
          role: "Angular divergence of the reflected beam ($9.0\\text{ to }14.0\\text{ mrad}$)",
          unit: "Milliradians (mrad)",
          dimension: "[1]",
          explanation:
            "Dynamically modulated as acoustic pressure flexes the mirror diaphragm between convex and concave curvature.",
        },
        {
          id: "d_lens",
          symbol: "D_0",
          name: "Transmitter Aperture Diameter",
          color: "cyan",
          role: "Clear aperture of the transmitter projection lens ($0.10\\text{ to }0.15\\text{ m}$)",
          unit: "Meters (m)",
          dimension: "[L]",
          explanation:
            "Collimates the reflected rays into a narrow pencil directed toward the receiver.",
        },
      ],
      pedagogicalNote:
      ...
      claimRef: 1,
      historicalSignificance:
        "US 235,199 pioneered free-space optical telecommunications (FSO) and fiber optic principles over a century before laser diodes and silica glass fibers became the backbone of the global internet.",
    },
    {
      id: "photophone-selenium-photoconductance-audio",
      patentId: "us-235199-bell-photophone",
      title: "Selenium Photoconductivity Power Law & Telephonic Audio Signal Current",
      category: "Semiconductor Physics & Electro-Acoustics",
      rawLatex:
      ...
      colorizedLatex:
        "\\textcolor{#059669}{R_{\\text{se}}(t)} = \\frac{\\textcolor{#2563eb}{R_{\\text{dark}}}}{1 + \\textcolor{#d97706}{\\beta} \\sqrt{\\textcolor{#dc2626}{P_{\\text{cell}}(t)}}} \\quad \\text{and} \\quad \\textcolor{#9333ea}{\\Delta I(t)} = -\\frac{\\textcolor{#ea580c}{V_{\\text{bat}}} \\cdot \\textcolor{#0891b2}{\\Delta R_{\\text{se}}(t)}}{(\\textcolor{#059669}{R_{\\text{se}}} + R_{\\text{phone}})^2}",
      plainEnglishSentence: [
        { text: "The " },
        { text: "illuminated selenium resistance", variableId: "r_se" },
        { text: " decreases from " },
        { text: "dark resistance", variableId: "r_dark" },
        { text: " according to the " },
        { text: "photoconductivity coefficient", variableId: "beta_photo" },
        { text: " and " },
        { text: "concentrated radiant power", variableId: "p_cell" },
        { text: ", generating " },
        { text: "AC audio signal current", variableId: "di_audio" },
        { text: " powered by the " },
        { text: "battery voltage", variableId: "v_bat" },
        { text: " and " },
        { text: "dynamic resistance swing", variableId: "dr_se" },
        { text: " to drive the telephone receiver." },
      ],
      variables: [
        {
          id: "r_se",
          symbol: "R_{\\text{se}}(t)",
          name: "Operating Selenium Resistance",
          color: "emerald",
          role: "Instantaneous electrical resistance of the multi-disc selenium cell under light ($20\\text{ to }80\\text{ k}\\Omega$)",
          unit: "Ohms (kOhm)",
          dimension: "[M L^2 T^-3 I^-2]",
          explanation:
            "Drops rapidly as incoming photon flux generates electron-hole pairs in the crystalline selenium semiconductor lattice.",
          telemetryKey: "collectorDiameterM",
        },
        {
          id: "r_dark",
          symbol: "R_{\\text{dark}}",
          name: "Unilluminated Dark Resistance",
          color: "sapphire",
          role: "Baseline resistance of the annealed selenium cell in total darkness ($150\\text{ to }300\\text{ k}\\Omega$)",
          unit: "Ohms (kOhm)",
          dimension: "[M L^2 T^-3 I^-2]",
          explanation:
            "Determined by the geometry of the stacked brass disks and the microscopic thickness of the mica insulating washers.",
        },
        {
          id: "beta_photo",
          symbol: "\\beta",
          name: "Photoconductive Sensitivity Coefficient",
          color: "amber",
          role: "Empirical sensitivity factor of crystalline annealed selenium ($\\beta \\approx 1.2\\text{ to }1.8\\text{ mW}^{-1/2}$)",
          unit: "milliwatts^-1/2 (mW^-0.5)",
          dimension: "[M^-0.5 L^-1 T^1.5]",
          explanation:
            "Reflects the carrier recombination lifetime and hole mobility in gray hexagonal crystalline selenium.",
        },
        {
          id: "p_cell",
          symbol: "P_{\\text{cell}}(t)",
          name: "Concentrated Radiant Power on Cell",
          color: "crimson",
          role: "Total modulated optical power focused by the parabolic mirror onto the selenium cylinder ($1.0\\text{ to }50.0\\text{ mW}$)",
          unit: "Milliwatts (mW)",
          dimension: "[M L^2 T^-3]",
          explanation:
            "Concentrated over a $0.196\\text{ m}^2$ parabolic mirror surface with $88\\%$ specular reflectivity.",
        },
        {
          id: "di_audio",
          symbol: "\\Delta I(t)",
          name: "AC Audio Telephonic Current",
          color: "amethyst",
          role: "Modulated signal current driving the electromagnetic telephone receiver ($1.0\\text{ to }25.0\\;\\mu\\text{A}$)",
          unit: "Microamperes (uA)",
          dimension: "[I]",
          explanation:
            "Flows through the receiver electromagnet coils, vibrating the iron diaphragm to generate audible acoustic speech.",
        },
        {
          id: "v_bat",
          symbol: "V_{\\text{bat}}",
          name: "Battery Supply Potential",
          color: "coral",
          role: "DC bias voltage supplied by Leclanché or Grove electrochemical battery cells ($6.0\\text{ to }18.0\\text{ V}$)",
          unit: "Volts (V)",
          dimension: "[M L^2 T^-3 I^-1]",
          explanation:
            "Biases the selenium photoconductive bridge to convert resistance fluctuations into audio loop current.",
        },
        {
          id: "dr_se",
          symbol: "\\Delta R_{\\text{se}}(t)",
          name: "Dynamic Resistance Modulation Swing",
          color: "cyan",
          role: "Peak-to-peak resistance variation caused by voice modulation ($2.0\\text{ to }15.0\\text{ k}\\Omega$)",
          unit: "Ohms (kOhm)",
          dimension: "[M L^2 T^-3 I^-2]",
          explanation:
            "Directly proportional to speech acoustic intensity and mirror curvature modulation.",
        },
      ],
      pedagogicalNote:
      ...
      claimRef: 18,
      historicalSignificance:
        "Bell's cylindrical multi-disc selenium cell was the world's first practical solid-state semiconductor photodetector, establishing the fundamental design of interdigital photodetectors used in modern optical transceivers.",
    },
  ],
  ...
  // Norbert Rillieux Multiple-Effect Vacuum Evaporation Process (US 3,237)
  "us-3237-rillieux-evaporator": [
    {
      id: "rillieux-multiple-effect-steam-economy",
      patentId: "us-3237-rillieux-evaporator",
      title: "Rillieux Multiple-Effect Steam Economy & Latent Heat Cascading Law",
      category: "Chemical Thermodynamics & Multi-Effect Evaporation",
      rawLatex:
      ...
      colorizedLatex:
        "\\textcolor{#059669}{S} = \\frac{\\textcolor{#2563eb}{\\dot{m}_{\\text{evap,total}}}}{\\textcolor{#dc2626}{\\dot{m}_{\\text{steam}}}} = \\sum_{i=1}^N \\frac{\\textcolor{#d97706}{U_i} \\textcolor{#0891b2}{A_i} \\textcolor{#ea580c}{\\Delta T_i}}{\\textcolor{#dc2626}{\\dot{m}_{\\text{steam}}} \\textcolor{#9333ea}{h_{fg,i}}} \\approx \\textcolor{#059669}{N} \\cdot \\eta_{\\text{thermal}}",
      plainEnglishSentence: [
        { text: "The " },
        { text: "steam economy ratio", variableId: "s_economy" },
        { text: " measures the " },
        { text: "total water evaporated", variableId: "m_evap" },
        { text: " per pound of " },
        { text: "primary boiler steam", variableId: "m_steam" },
        { text: " across " },
        { text: "number of cascading effects", variableId: "s_economy" },
        { text: ", driven by the " },
        { text: "overall heat transfer coefficient", variableId: "u_coeff" },
        { text: ", " },
        { text: "submerged tube surface area", variableId: "a_tube" },
        { text: ", and " },
        { text: "inter-effect temperature drop", variableId: "dt_effect" },
        { text: "." },
      ],
      variables: [
        {
          id: "s_economy",
          symbol: "S",
          name: "Steam Economy Factor",
          color: "emerald",
          role: "Ratio of total mass of water evaporated to primary boiler steam consumed ($2.6\\text{ to }3.8\\text{ kg/kg}$ in triple/quadruple effects)",
          ...
          telemetryKey: "numberOfEffects",
        },
        {
          id: "m_evap",
          symbol: "\\dot{m}_{\\text{evap,total}}",
          name: "Total Evaporated Water Mass Flow Rate",
          color: "sapphire",
          role: "Total rate of water vapor boiled off from cane juice across all effects ($5,000\\text{ to }25,000\\text{ kg/h}$)",
          unit: "kg / hour (kg/h)",
          dimension: "[M T^-1]",
          explanation:
            "Concentrates dilute cane juice (14 °Bx) into rich crystalline syrup (65 °Bx).",
          telemetryKey: "juiceFeedRateKgPerH",
        },
        {
          id: "m_steam",
          symbol: "\\dot{m}_{\\text{steam}}",
          name: "Primary Boiler / Exhaust Steam Consumption",
          color: "crimson",
          role: "Mass rate of live boiler or engine exhaust steam supplied only to Effect 1 ($1,500\\text{ to }8,000\\text{ kg/h}$)",
          unit: "kg / hour (kg/h)",
          dimension: "[M T^-1]",
          explanation:
            "Supplies the initial thermal energy that cascades through all subsequent vacuum stages.",
        },
        {
          id: "u_coeff",
          symbol: "U_i",
          ...
          color: "amber",
          role: "Thermal conductance across copper tube bundle walls ($1,100\\text{ to }2,400\\text{ W/m}^2\\text{K}$)",
          unit: "Watts / meter squared Kelvin (W/m^2 K)",
          dimension: "[M T^-3 Theta^-1]",
          explanation:
            "Governed by steam-side condensation film coefficient and boiling juice natural convective circulation.",
        },
        {
          id: "a_tube",
          symbol: "A_i",
          name: "Submerged Heating Tube Surface Area",
          color: "cyan",
          role: "Total outer heat transfer area of horizontal copper steam pipe bundles ($50\\text{ to }250\\text{ m}^2$ per vessel)",
          unit: "Meters squared (m^2)",
          dimension: "[L^2]",
          explanation:
            "Provides vast contact area with boiling juice without hot spots or scorched caramelization.",
        },
        {
          id: "dt_effect",
          symbol: "\\Delta T_i",
          name: "Thermal Driving Potential Difference",
          color: "coral",
          role: "Temperature difference between condensing steam in tubes and boiling juice in shell ($12\\text{ to }25^\\circ\\text{C}$)",
          unit: "Degrees Celsius (°C)",
          dimension: "[Theta]",
          explanation:
            "Created by maintaining successively lower saturation pressures in each subsequent enclosed vessel.",
        },
        {
          id: "h_fg",
          symbol: "h_{fg,i}",
          ...
          color: "amethyst",
          role: "Enthalpy released when steam condenses and absorbed when water boils ($\\approx 2,260\\text{ kJ/kg}$)",
          unit: "Kilojoules / kilogram (kJ/kg)",
          dimension: "[L^2 T^-2]",
          explanation:
            "The recycled thermal carrier that evaporates subsequent juice at no extra fuel cost.",
        },
      ],
      pedagogicalNote:
      ...
      claimRef: 2,
      historicalSignificance:
        "US 3,237 is the foundational patent of modern chemical engineering thermodynamics, industrial multi-effect desalination, petroleum distillation, and chemical process plant energy integration.",
    },
    {
      id: "rillieux-brix-mass-balance-boiling-point",
      patentId: "us-3237-rillieux-evaporator",
      title: "Cane Juice Brix Mass Balance & Solution Boiling-Point Elevation",
      category: "Process Mass Balance & Solution Thermodynamics",
      rawLatex:
        "\\dot{m}_{\\text{syrup}} = \\dot{m}_{\\text{feed}} \\left(\\frac{B_{\\text{in}}}{B_{\\text{out}}}\\right) \\quad \\text{and} \\quad \\Delta T_{\\text{bpe}} = 0.07 B + 0.0022 B^2",
      colorizedLatex:
        "\\textcolor{#9333ea}{\\dot{m}_{\\text{syrup}}} = \\textcolor{#2563eb}{\\dot{m}_{\\text{feed}}} \\left(\\frac{\\textcolor{#059669}{B_{\\text{in}}}}{\\textcolor{#d97706}{B_{\\text{out}}}}\\right) \\quad \\text{and} \\quad \\textcolor{#ea580c}{\\Delta T_{\\text{bpe}}} = 0.07 \\textcolor{#d97706}{B} + 0.0022 \\textcolor{#d97706}{B}^2",
      plainEnglishSentence: [
        { text: "The " },
        { text: "concentrated syrup output rate", variableId: "m_syrup" },
        { text: " equals the " },
        { text: "raw juice feed rate", variableId: "m_feed" },
        { text: " scaled by the ratio of " },
        { text: "initial dissolved solids", variableId: "b_in" },
        { text: " to " },
        { text: "target syrup Brix concentration", variableId: "b_out" },
        { text: ", which causes a proportional " },
        { text: "boiling point elevation", variableId: "dt_bpe" },
        { text: " that Rillieux measured with his differential thermometer." },
      ],
      variables: [
        {
          id: "m_syrup",
          symbol: "\\dot{m}_{\\text{syrup}}",
          name: "Concentrated Syrup Output Flow",
          color: "amethyst",
          role: "Mass output rate of concentrated heavy syrup ready for crystallization strike ($1,000\\text{ to }5,000\\text{ kg/h}$)",
          unit: "kg / hour (kg/h)",
          dimension: "[M T^-1]",
          explanation: "Contains the purified concentrated sucrose at target saturation Brix.",
        },
        {
          id: "m_feed",
          symbol: "\\dot{m}_{\\text{feed}}",
          name: "Clarified Cane Juice Inflow",
          color: "sapphire",
          role: "Inlet rate of clarified dilute cane juice fed into Effect 1 ($5,000\\text{ to }30,000\\text{ kg/h}$)",
          unit: "kg / hour (kg/h)",
          dimension: "[M T^-1]",
          explanation:
            "Extracted from crushed sugar cane and clarified with lime before entering the evaporator train.",
          telemetryKey: "juiceFeedRateKgPerH",
        },
        {
          id: "b_in",
          symbol: "B_{\\text{in}}",
          name: "Initial Dissolved Solids Concentration",
          color: "emerald",
          role: "Sugar concentration of raw clarified cane juice ($12\\text{ to }16^\\circ\\text{Bx}$)",
          unit: "Degrees Brix (°Bx)",
          dimension: "[1]",
          explanation: "Percentage by weight of dissolved sucrose in aqueous solution.",
          telemetryKey: "initialBrixDeg",
        },
        {
          id: "b_out",
          symbol: "B_{\\text{out}}",
          name: "Target Syrup Concentration",
          color: "amber",
          role: "Target syrup Brix concentration prior to strike-pan crystallization ($60\\text{ to }70^\\circ\\text{Bx}$)",
          unit: "Degrees Brix (°Bx)",
          dimension: "[1]",
          explanation:
            "The precise density required to trigger optimal sugar crystal nucleation without premature pan foul.",
          telemetryKey: "targetBrixDeg",
        },
        {
          id: "dt_bpe",
          symbol: "\\Delta T_{\\text{bpe}}",
          name: "Boiling Point Elevation (BPE)",
          color: "coral",
          role: "Colligative boiling point increase due to dissolved sucrose ($1.5\\text{ to }9.5^\\circ\\text{C}$)",
          unit: "Degrees Celsius (°C)",
          dimension: "[Theta]",
          explanation:
            "Detected by Rillieux's differential thermometer to automatically throttle juice feed valves.",
        },
      ],
      pedagogicalNote:
      ...
      claimRef: 4,
      historicalSignificance:
        "Rillieux's differential thermometer was the world's first automated industrial process composition controller, anticipating modern automated chemical process control by nearly a century.",
    },
  ],
...
ALL_COLORIZED_EQUATIONS["gb-1306-watt-rotary-engine"] = [
  {
...
ALL_COLORIZED_EQUATIONS["gb-1420-cort-puddling-rolling"] = [
  {
...
ALL_COLORIZED_EQUATIONS["us-3138743-kilby-integrated-circuit"] = [
  {
...
ALL_COLORIZED_EQUATIONS["us-2929922-townes-laser"] = [
  {
  ...
  },
  {
    ...
    variables: [
      ...
      },
      {
        ...
        unit: "mm",
        dimension: "L",
        explanation: "Larger apertures produce narrower, more parallel diffraction-limited beams.",
...
ALL_COLORIZED_EQUATIONS["us-2297691-carlson-electrophotography"] = [
  {
    ...
    variables: [
      ...
      },
      {
        ...
        unit: "F/m",
        dimension: "M^-1 L^-3 T^4 I^2",
        explanation: "Determines the layer capacitance and electrostatic charge storage capacity.",
    ...
    variables: [
      {
        ...
        unit: "N",
        dimension: "M L T^-2",
        explanation: "Must exceed gravitational and inertial forces to adhere cleanly to the drum.",
...
ALL_COLORIZED_EQUATIONS["us-706737-fessenden-wireless"] = [
  {
...
ALL_COLORIZED_EQUATIONS["us-879532-de-forest-audion"] = [
  {
    ...
    variables: [
      ...
      },
      {
        ...
        unit: "V",
        dimension: "M L^2 T^-3 I^-1",
        explanation: "Controls the height of the potential barrier confronting emitted electrons.",
    ...
    variables: [
      {
        ...
        unit: "dimensionless",
        dimension: "1",
        explanation: "Directly determines how much the telephone receiver audio volume increases.",
        telemetryMetricLabel: "Voltage Amplification Gain",
      },
      {
        id: "mu_gain",
...
ALL_COLORIZED_EQUATIONS["us-682690-hewitt-mercury-lamp"] = [
  {
    ...
    variables: [
      ...
      },
      {
        ...
        unit: "dimensionless",
        dimension: "1",
        explanation: "Reflects the non-linear ionization kinetics of low-pressure mercury plasma.",
...
ALL_COLORIZED_EQUATIONS["us-971501-haber-ammonia"] = [
  {
  ...
  },
  {
    ...
    variables: [
      ...
      },
      {
        ...
        unit: "Pa",
        dimension: "M L^-1 T^-2",
        explanation: "High hydrogen concentration prevents surface poisoning by adsorbed nitrogen.",
        telemetryMetricLabel: "Feed Pressure",
      },
      {
        id: "k2",
...
ALL_COLORIZED_EQUATIONS["us-3353115-maiman-ruby-laser"] = [
  {
