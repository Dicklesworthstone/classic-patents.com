...
export const hollerithArchivalEdition: CuratedSpecificationEdition = {
  ...
  blocks: [
    ...
    p(
      ...
      makePreview("FIG. 2", [2], "Cross-Section of Spring Pin Sensing Press and Mercury Contact Matrix"),
