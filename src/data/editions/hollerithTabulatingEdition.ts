...
export const hollerithTabulatingSourcePage9Draft: readonly CuratedSpecificationBlock[] = [
  ...
  },
  {
    ...
    inlines: [
      ...
      {
        kind: "text",
        text: "; nor is it in any way essential that the movement should be confined to the plate C, for, if the plate B be reciprocated the same actions would be produced. Having now described the several improvements in the form of record-card and the apparatus used in connection therewith for effecting the desired electrical changes in the circuits as compared with the corresponding parts of the system shown in my prior application, I will proceed to explain the improvements appertaining to the method and system.",
      },
    ],
  },
];
