...
export const hollerithTabulatingSourcePage9Draft: readonly CuratedSpecificationBlock[] = [
  ...
  },
  {
    ...
    inlines: [
      {
        kind: "text",
        { kind: "text", text: "As will be obvious to those skilled in the art, different equivalent forms of contacts or circuit-varying devices can readily be substituted for those herein shown without departing from the spirit of my invention; and although I prefer, for various good and sufficient reasons, the arrangement shown, having found the same to be well adapted for carrying my invention into practical use, I do not wish to be understood as restricting myself to such an arrangement of circuit-varying devices; nor is it essential that the pins c, operating with the card, should themselves be part of the circuit or operate directly to vary the current, for, as is obvious, the same arrangement of pins can be made to operate through intermediate mechanism to actuate circuit-controlling devices independent of, or removed from, the plate B—for example, as shown in " },
      figureReference("Fig. 15", ...hollerithTabulatingFigureCrops["Fig. 15"]),
      { kind: "text", text: "; nor is it in any way essential that the movement should be confined to the plate C, for, if the plate B be reciprocated the same actions would be produced. Having now described the several improvements in the form of record-card and the apparatus used in connection therewith for effecting the desired electrical changes in the circuits as compared with the corresponding parts of the system shown in my prior application, I will proceed to explain the improvements appertaining to the method and system." },
      },
    ],
  },
];
