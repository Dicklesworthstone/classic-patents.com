...
const figure = (label: "Fig. 1" | "Fig. 2" | "Fig. 3"): CuratedSpecificationInline => ({
  kind: "reference",
  text: label,
  ...
  figurePreviews: [
    {
      src: `/patents/figures/us-31128-otis-elevator/figure-${label.at(-1)}.png`,
      alt:
        label === "Fig. 1"
      ...
      width: 1750,
      height: label === "Fig. 1" ? 1050 : label === "Fig. 2" ? 1400 : 360,
    },
  ],
});
...
export const otisElevatorArchivalEdition: CuratedSpecificationEdition = {
  ...
  blocks: [
    ...
    },
    {
      kind: "paragraph",
      inlines: [
        { kind: "text", text: "Figure 1 is a vertical section of my invention, taken in the line x x, " },
        figure("Fig. 2"),
        { kind: "text", text: "; " },
        figure("Fig. 2"),
    ...
    { kind: "paragraph", inlines: text("Similar letters of reference indicate corresponding parts in the several figures.") },
    {
      kind: "paragraph",
      inlines: text(
    ...
    { kind: "paragraph", inlines: text("To enable those skilled in the art to fully understand and construct my invention, I will proceed to describe it.") },
    {
      kind: "paragraph",
      inlines: [
        { kind: "text", text: "A represents a base or platform, to which two uprights B B are secured, said uprights having each a rack C at its inner side. These racks C have teeth of hook form, or the teeth may be described as having an inclination upward, as shown clearly in " },
        figure("Fig. 2"),
        { kind: "text", text: "." },
      ],
    },
    {
      kind: "paragraph",
      inlines: [
        { kind: "text", text: "Between the uprights B B a platform D is placed, the platform being secured to two uprights a a, which are grooved vertically to receive the racks C C. To each upright a a a bent lever E is attached by a fulcrum-pin b, and the inner ends of the levers E E overlap each other and are fitted in an eye c at the lower end of a vertical bar F, which passes loosely through a rail or bar d, that connects the upper ends of the uprights a a. To the lower end of the bar F a " },
        { kind: "term", text: "spring e", definition: "The spring connected to the vertical bar F; it biases the safety pawls toward engagement with the racks.", label: "Safety-spring designation" },
        { kind: "text", text: " is attached, said spring having a tendency to keep the pawls f, which are attached to the lower ends of the levers E E, in gear with the racks C C." },
      ],
    },
    {
      kind: "paragraph",
      inlines: [
        ...
        figure("Fig. 2"),
        { kind: "text", text: ", in which it will be seen that the pawls f are connected to the ends of the levers E by pivots, and have springs g attached, which springs have a tendency to keep the pawls pressed down into or between the teeth of the racks C. The pawls, it will be seen, fit or work in mortises h in the uprights a a." },
      ],
    },
    {
      kind: "paragraph",
    ...
    },
    {
      kind: "paragraph",
      inlines: [
        { kind: "text", text: "The belts O P pass through eyes m, attached to the slide S, which forms a " },
        { kind: "term", text: "belt-shipper", definition: "A sliding guide that moves a belt between an idle pulley and a driving pulley.", label: "Power-transmission term" },
        { kind: "text", text: ". This slide is fitted in suitable guides n n and has a rack o at one end, into which a pinion p gears. The pinion p is on a shaft q, which has a drum r placed on it, around which a rope T passes, said rope being secured to the drum r and wound around it in opposite directions. The rope T also passes over pulleys s s and down around a pulley t near the base A." },
      ],
    },
    {
      kind: "paragraph",
      inlines: [
        { kind: "text", text: "To the portion of the rope T between the pulleys s s and t a rope U is attached by a branched end V, each part u of which is attached to a side of the rope T, as shown clearly in " },
        figure("Fig. 3"),
        { kind: "text", text: ". To the slide or belt-shipper S there is attached an arm W, the lower end of which is attached by a pivot to a bar X. This bar X is attached by a pivot v to one of the uprights M, and the bar X is provided with a pendent projection x, which bears on a bar Y, one end of which is attached by a pivot to one of the uprights M and the opposite end fitted in a guide a′ on one of the uprights. To the bar Y at about its center a shoe Z is attached, which, when the bar Y is pressed downward, bears upon the working-pulley L." },
      ],
    },
    {
      kind: "paragraph",
    ...
    { kind: "paragraph", inlines: text("Having thus described my invention, what I claim as new, and desire to secure by Letters Patent, is—") },
    { kind: "claim", number: 1, inlines: text("Having the pawls f f and the teeth of the racks C C hook-formed, essentially as shown, so that the weight of the platform will, in case of the breaking of the rope G, cause the pawls and teeth to lock together and prevent the contingency of a separation of the same, as herein set forth.") },
    { kind: "claim", number: 2, inlines: text("The arrangement of the ropes T, U, and V, combined and operating substantially as and for the purpose set forth.") },
    { kind: "claim", number: 3, inlines: text("The arrangement of the slide or belt-shipper S with the shoe or brake Z and rope T, substantially as shown, to admit of the simultaneous application of the brake and the shifting of the belts O P on the idle-pulleys J K, as set forth.") },
    { kind: "claim", number: 4, inlines: text("Attaching the rope Q of the counterpoise R to the drum H on the opposite side from the lifting-rope G, substantially as shown, so as to counterpoise the platform D without preventing or interfering with the action of the safety mechanism E e f.") },
    { kind: "paragraph", inlines: [{ kind: "small-caps", text: "E. G. OTIS." }] },
    { kind: "paragraph", inlines: text("Witnesses: M. M. LIVINGSTON, G. H. REED.") },
    { kind: "figure-sheet", figureLabel: "Fig. 1", title: "Vertical section", description: text("Source-faithful crop from drawing sheet 1: a vertical section of the complete hoisting apparatus, taken on line x x of Figure 2.") },
    { kind: "figure-sheet", figureLabel: "Fig. 2", title: "Front view", description: text("Source-faithful crop from drawing sheet 1: front view of the apparatus, including the platform, racks, pawls, winding gear, belts, and brake linkage.") },
    { kind: "figure-sheet", figureLabel: "Fig. 3", title: "Detached stop mechanism", description: text("Source-faithful crop from drawing sheet 1: detached side view of the stop mechanism that brings the branched rope end into a horizontal, non-actuating position when the brake is applied.") },
  ],
};
