...
const missingFigures = (): CuratedSpecificationInline => ({
  kind: "reference",
  text: "Figs. 11 and 12",
  href: "#source-omission-figures-11-12",
  referenceType: "figure",
  label:
...
export const zeppelinAirshipArchivalEdition: CuratedSpecificationEdition = {
  ...
  blocks: [
    ...
    p([
      ...
      { kind: "text", text: " is a side elevation of my improved navigable balloon or air craft. " },
      figure("Fig. 2"),
      { kind: "text", text: " is a front elevation thereof. " },
      figure("Fig. 3"),
      { kind: "text", text: " is a longitudinal section showing a part of the said craft drawn to an enlarged scale. " },
      figure("Fig. 4"),
      { kind: "text", text: " is a transverse section through the craft. " },
      figure("Fig. 5", "Figs. 5"),
      { kind: "text", text: " and " },
      figure("Fig. 6", "6"),
      { kind: "text", text: " show the arrangement of the separate gas bags or envelops in the several compartments of the balloon. " },
      figure("Fig. 7", "Figs. 7"),
      { kind: "text", text: " and " },
      figure("Fig. 8", "8"),
      { kind: "text", text: " show in side elevation and plan, respectively, the arrangement of an adjustable running-weight which serves for giving the balloon any desired inclination to the horizontal. " },
      figure("Fig. 9"),
      { kind: "text", text: " shows a modification in which the running-weight is replaced by adjustable towing or trailing ropes. " },
      figure("Fig. 10"),
      { kind: "text", text: " shows a number of balloons connected together, so as to form a train. " },
      missingFigures(),
      { kind: "text", text: " illustrate the method of coupling the several balloons together." },
    ]),
    p([
      { kind: "text", text: "In order to give the balloon a rigid form, it is provided with a framework or skeleton of tubes " },
      term(
        "r",
    ...
    p(text("Having now described particularly the nature of my invention, what I claim, and desire to secure by Letters Patent, is—")),
    claim(
      1,
      "1. In a balloon, the combination of a framework divided into separate compartments, with a main gas-bag in each compartment, adapted to expand and fill the same when permitted, and auxiliary gas-bags in the compartments for maneuvering, to permit the main gas-bags to retain their full quantity of gas unaffected by the admission of air, substantially as set forth.",
    ),
    claim(
      2,
      "2. The combination of a balloon, with a running-weight suspended beneath the same, rotary drums provided with fusees, and a rope stretched from the weight to and around each fusee, substantially as and for the purpose set forth.",
    ),
    claim(
      3,
      "3. The combination of a balloon, with a weight suspended beneath the same, and adjustable in height, a movable carriage supporting the weight, rotary drums to which the carriage is connected and which are provided with fusees and a rope stretched from the weight to and around each fusee, substantially as and for the purpose set forth.",
    ),
    claim(
      4,
      "4. An air-craft comprising a series of balloons coupled together and provided with rigid casings, the foremost of said balloons being provided with driving mechanism, and the remainder adapted to carry the load or freight, and extensible covers secured to the rigid casings and covering the intermediate spaces between two adjacent balloons.",
    ),
    p(text("In testimony that I claim the foregoing as my invention I have signed my name in presence of two subscribing witnesses.")),
...
export const zeppelinAirshipParallelReadings: Readonly<Record<number, readonly string[]>> = {
  ...
  7: ["Zeppelin identifies himself, his Stuttgart location, and his military title, then states that the following text is the complete enabling description required for the patent."],
  8: ["The invention treats a navigable balloon as a long, narrow powered vessel. Separating motors allows a smaller hull diameter for a given propulsive capability, and the text also contemplates a powered leading craft towing or coupling load-carrying balloons."],
  9: ["This paragraph maps the document’s figures: elevation and cross-section views, gas-bag compartments, a movable trim weight, a trailing-rope alternative, and a train of connected balloons. The printed references to Figures 11 and 12 remain, but their panels are absent from the served facsimile."],
  10: ["The rigid hull is a tube, wire-rope, and mesh framework under a silk-like outer casing. Partitions, vertical stays, rings, and diagonal stays create chambers for folded gas bags; leaving free volume lets the gas expand at altitude or when heated while valves handle exceptional release."],
  11: ["Auxiliary maneuvering bags are filled before the main bags. Releasing gas from those auxiliary bags lets the main bags expand upward into the chamber, preserving the main lifting gas instead of admitting air to compensate for fuel consumed on a long journey."],
  12: ["A rigid gangway gives access to the hull and supports cars for crew, fuel, passengers, and cargo. Each driving mechanism turns two propellers placed laterally near the craft’s center of resistance, the source’s aerodynamic reference for a force application point."],
  13: ["Two rudders, above and below the hull at either end, provide lateral steering through suitable operating gear. The passage states placement and function but does not claim a later three-axis aircraft-control system."],
  14: ["A suspended running weight shifts longitudinally on a traveler to trim the balloon level or inclined. The paired drums and shaped fusees keep the two supporting ropes under light tension, so the weight’s gravity supplies a restoring pull as the craft’s attitude changes."],
  15: ["The trim weight may be disconnected from the drum mechanism when used simply as a hanging weight. Alternatively, adjustable towing or trailing ropes can be moved along the hull and tied together in flight so their geometry helps keep the vehicle in its selected position."],
  16: ["A powered balloon can tow similarly built but unpowered load balloons as a train. The claim-side description uses movable couplings and an extensible cover over the gap to keep wind from catching the intermediate space; the cited Figures 11 and 12 are missing from the supplied drawing sheets."],
  17: ["Zeppelin proposes balancing unequal buoyancy among balloons in a train by transferring liquids, heavy cargo, or by condensing gas or atmospheric air. These are operating options for compensating mass or gas changes, not a quantified performance guarantee."],
  18: ["This sentence marks the transition from the descriptive specification to the four legal claims that define the asserted combinations."],
  23: ["This closing attestation says that Zeppelin signed in the presence of two subscribing witnesses, making the signature and witness lines that follow part of the printed legal formalities."],
  24: ["The printed signature identifies Ferdinand Graf Zeppelin and gives the two witnesses as Wm. Hahn and H. Wagner; the bracketed L. S. is the printed seal notation."],
};
