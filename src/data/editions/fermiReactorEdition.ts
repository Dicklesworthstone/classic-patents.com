...
const fermiPages30To35ReconciledBlocks: readonly CuratedSpecificationBlock[] = [
  ...
  paragraph([
    text(
      "The symmetrical arrangement of the uranium lumps in the moderator is called a ",
    ),
    term(
      "lattice",
  ...
  paragraph([
    text(
      "The same procedure can be used when ",
    ),
    term(
      "liquid moderators",
  ...
  paragraph([
    ...
    figure(1, "Fig. 1"),
    text(" is a diagram or chart illustrating the balanced condition of a chain reaction in a system of practical size employing natural uranium in graphite; "),
    figure(2, "Fig. 2"),
    text(" is a graph on which are plotted contour lines representing various reproduction constants K for systems employing uranium metal spheres and graphite; "),
    figure(3, "Fig. 3"),
    text(" is a graph similar to that of "), figure(2, "Fig. 2"), text(" for cylindrical rods of uranium metal; and "),
    figure(4, "Fig. 4"),
    text(" is a graph on which are plotted contour lines representing various values for the reproduction constants K for a uranium oxide (UO2)-graphite system wherein the oxide is in the form of spheres.")
  ]),
  paragraph([
    text("The remainder of the drawing inventory continues: "),
    figure(5, "Fig. 5"), text(" is a graph showing various reproduction constants K for uranium oxide and graphite with the oxide in cylindrical rods; "),
    figure(6, "Fig. 6"), text(" is a graph showing K contour lines for uranium metal rods immersed in D2O; "),
    figure(7, "Fig. 7"), text(" is a perspective view of a uranium-graphite reactor enclosed in a radiation shield; "),
    figure(8, "Fig. 8"), text(" is a front end plan view of that reactor, partly in central vertical section; "),
    figure(9, "Fig. 9"), text(" is a side plan view, partly in central vertical section; "),
    figure(10, "Fig. 10"), text(" is a top plan view, partly in central horizontal section; "),
    figure(11, "Fig. 11"), text(" is a plan view of a graphite block containing uranium metal, partly broken away to show a uranium-metal cylinder in section; "),
    figure(12, "Fig. 12"), text(" is a longitudinal sectional view taken on line 12–12 of "), figure(11, "Fig. 11"), text("; "),
    figure(13, "Fig. 13"), text(" is a longitudinal sectional view of a graphite block showing uranium-oxide pseudospheres in place of uranium metal; "),
    figure(14, "Fig. 14"), text(" is a plan view of a graphite block loaded with uranium-oxide pseudospheres, partly broken away to show a pseudosphere in section on line 14–14 of "), figure(13, "Fig. 13"), text("; "),
    figure(15, "Fig. 15"), text(" is a plan view of a dead graphite brick, partly broken away and shown in section; "),
    figure(16, "Fig. 16"), text(" is a schematic wiring diagram of a neutron-density monitoring circuit; "),
    figure(17, "Fig. 17"), text(" is a graph showing neutron-density values plotted in relation to the number of layers as a cubical reactor is built; "),
    figure(18, "Fig. 18"), text(" is a diagrammatic side view of a safety rod; "),
    figure(19, "Fig. 19"), text(" is a diagrammatic side view of a shim or limiting rod; "),
    figure(20, "Fig. 20"), text(" is a diagrammatic side view of a control rod; "),
    figure(21, "Fig. 21"), text(" is a graph on which are plotted neutron-density value relations found in the active portion of the system against number of layers of graphite bricks for an ellipsoidal reactor; "),
    figure(22, "Fig. 22"), text(" is an enlarged, fragmentary perspective view of a modified active portion in the form of a cube or parallelepiped with uranium arranged horizontally in cylinders or rods; "),
    figure(23, "Fig. 23"), text(" is a second modification of the active portion wherein the overall shape is cylindrical and the uranium is disposed vertically in cylinders or rods; "),
    figure(24, "Fig. 24"), text(" is a diagram illustrating the distribution of neutron density in a spherical reactor.")
  ]),
  paragraph([
    text("The remaining figures are: "),
    figure(25, "Fig. 25"), text(" is a vertical sectional view of a neutronic reactor employing deuterium oxide as moderator; "),
    figure(26, "Fig. 26"), text(" is an enlarged fragmentary vertical sectional view through a portion of that reactor, particularly a uranium rod; "),
    figure(27, "Fig. 27"), text(" is a fragmentary detail sectional view corresponding to "), figure(26, "Fig. 26"), text(" but showing a modification of the ball-valve seal; "),
    figure(28, "Fig. 28"), text(" is an enlarged vertical sectional view of a portion of a uranium rod equipped with an adapter for removing the rod; "),
    figure(29, "Fig. 29"), text(" is a horizontal sectional view, partly in elevation, taken on line 29–29 of "), figure(25, "Fig. 25"), text("; "),
    figure(30, "Fig. 30"), text(" is a diagram showing change of critical size in U-C reactors with change in K; "),
    figure(31, "Fig. 31"), text(" is a longitudinal view, partly in section and partly in elevation, of an air-cooled neutronic reactor system; "),
    figure(32, "Fig. 32"), text(" is a cross-sectional view, partly in elevation, taken on line 32–32 of "), figure(31, "Fig. 31"), text("; "),
    figure(33, "Fig. 33"), text(" is a plan view of the system shown in "), figure(31, "Figs. 31 and 32", [32]), text("; "),
    figure(34, "Fig. 34"), text(" is a longitudinal sectional view, partly in elevation, of a jacketed slug; "),
    figure(35, "Fig. 35"), text(" is a longitudinal sectional view, partly in elevation, of a horizontal channel during a loading and unloading operation; "),
    figure(36, "Fig. 36"), text(" is a cross-sectional view taken on line 36–36 of "), figure(35, "Fig. 35"), text("; "),
    figure(37, "Fig. 37"), text(" is a vertical sectional view, partly in elevation, of a liquid-cooled reactor; "),
    figure(38, "Fig. 38"), text(" is a vertical sectional view, partly in elevation, of the reactor shown in "), figure(37, "Fig. 37"), text(", taken on line 38–38 of "), figure(37, "Fig. 37"), text("; "),
    figure(39, "Fig. 39"), text(" is a diagrammatic perspective view of a uranium rod and associated coolant channel; "),
    figure(40, "Fig. 40"), text(" is a diagram showing the statistical weight of concentric lattice portions of uniform K plotted against the extent of the same lattice portions within the structure; "),
    figure(41, "Fig. 41"), text(" is a diagram showing the effect of reflectors of various thickness on the size of the reactor; and "),
    figure(42, "Fig. 42"), text(" is a diagram showing the outline of a reactor in the shape, roughly, of an ellipsoid.")
  ]),
  {
    kind: "equation",
    text: "K = 1 − M²A (5)",
...
const fermiPages30To35ParallelReadings: Readonly<Record<number, readonly string[]>> = {
  18: ["PDF page 30 completes the fission-fragment definitions, then explains in Fig. 1 how impurity capture, moderator absorption, and finite-size leakage consume neutrons while about 72 thermal neutrons sustain 100 new fast neutrons in the uranium-graphite chain."],
  19: ["PDF page 30 begins the numbered uranium-resonance-loss and moderator-loss sections: aggregation into bodies at least about 0.5 centimeter reduces surface capture, while the printed absorption-to-scattering ratios compare H2O, diphenyl, beryllium, graphite, and D2O."],
  20: ["PDF page 30 defines danger coefficients from impurity and uranium absorption cross sections, their weighted total danger sum, and the worked H/Co/Ag and Li/Co/Rh examples that reduce the reproduction constant K."],
  21: ["PDF page 31 continues the impurity-loss section, preserving the warnings that boron, cadmium, samarium, and gadolinium can defeat criticality at parts-per-million levels, while nitrogen pressure, oxide/carbide/fluoride chemistry, and moderator choice also affect the chain."],
  22: ["PDF page 31 records the danger-coefficient table and the maximum K values for pure uranium with graphite, beryllium metal or oxide, heavy water, and light water; unresolved column glyphs remain explicitly uncertain in the ledger rather than being fabricated."],
  23: ["PDF page 32 gives the permissible danger-sum thresholds for D2O, beryllium, and graphite, explains removable cadmium control headroom in Fig. 1, distinguishes finite-reactor leakage from infinite-medium K, and introduces the exponential-pile measurement method."],
  24: ["Page 33 presents the exponential-pile lattice model, relaxation distance, migration length, Bessel-series description, and the K equations used to infer reproduction from neutron-density measurements."],
  25: ["Page 33 continues the effective-side, operational-poisoning, indium-foil, harmonic-correction, end-correction, and adjacent-position measurement procedure for K."],
  26: ["Page 34 describes liquid-moderator measurements and defines the migration length as the mean-square displacement between neutron production and disappearance in the lattice."],
  27: ["Page 34 gives the proposed depleted-uranium experiment, exponential-pile Laplacian measurement, borated-water calibration, and the measured migration-length example."],
  28: ["Page 34 states the theoretical migration-length calculation, moderator values, neutron-purity test, and use of M squared in determining critical structure size."],
  29: ["Page 34 states the invention's object and begins the printed drawing inventory with authored semantic references for Figures 1 through 4."],
  30: ["Page 35 preserves the complete printed captions for Figures 5 through 42, including each figure's geometry, reactor embodiment, control component, measurement, reflector, or coolant role."],
};
...
const fermiPages36To42ReconciledBlocks: readonly CuratedSpecificationBlock[] = [
  paragraph([
    text(
      "AN ILLUSTRATIVE NEUTRONIC REACTOR HAVING A ",
    ),
    term(
      "SOLID MODERATOR",
    ...
    text(". Certain blocks 50 are drilled with cylindrical holes spaced 8 1/4 inches center to center to receive the uranium bodies and are termed live graphite. Other blocks 51, as shown in "),
    figure(15, "Fig. 15"),
    text(", contain no uranium and may be termed dead graphite. The uranium bodies are cast uranium-metal cylinders 52 and uranium-oxide pseudospheres 54, with a few U3O8 cylinders; the oxides are compressed to a density of about 6 grams/cm.³.\n\nThe uranium bodies are placed in holes in blocks 50. These live graphite blocks, together with dead graphite blocks 51, build a uranium-lump lattice of substantially cubical form surrounded by several layers of dead graphite acting as a reflector 17. Three bottom layers of dead graphite are laid on the foundation, and alternate layers may have their blocks crossed at right angles for more uniform distribution of weight."),
  ]),
  paragraph([
    ...
    text(" aligned with the rectangular coordinates of vault space 14. A central portion of metal lumps is positioned in stepped relation between the sixteenth and forty-eighth layers. Removable stringers, indicated at 36a in "),
    figure(9, "Figs. 9 and 10", [10]),
    text(", permit rows near a central diameter to be removed for test purposes. A horizontal removable section 56 extends from front to rear through the central portion containing metal and is eight rows wide and eight rows high.\n\nAs the reactor is built, matching blocks bored with a vertical 2 3/8-inch hole provide continuity of shaft 26. "),
    term(
      "Ionization chamber",
    ...
    text(" 60 is installed in channel 43 just inside wall 11; wire line 61 is connected to the monitoring circuit of "),
    figure(16, "Fig. 16"),
    ...
    text(" at one atmosphere and a central electrode 63. A battery of about 450 volts and galvanometer 70 measure alpha-ray ionization caused by neutron absorption in the boron.\n\nSlots 71 and 72 are provided for the shim and regulating rods, and safety-rod slots 73 are provided at right angles in a higher dead-graphite layer. Construction is continued with the shim rod, control rod, and safety rods fully inserted."),
  ]),
  paragraph([
    text("At least from the halfway point of construction, the natural neutron density in the pile is monitored as layers are added. Until critical size is reached, the short chains are "),
    term(
      "convergent",
    ...
    text(". By plotting neutron density within the pile against the layers, a prediction can be made in advance of the size at which the chain reaction will become self-sustaining. In "),
    figure(17, "Fig. 17"),
    text(" the results of "),
    term(
  ...
  paragraph([
    ...
    text(" only small powers can be continuously maintained without appreciable internal temperature rise. It is useful for manufacture of radioactive elements, as an intense source of neutrons through well 21 and shaft 26, as a generator of high-energy gamma rays, and for testing materials with removable stringers.\n\nThe power at a measurement location can be calculated from standard indium-foil "),
    term(
      "saturation activity",
    ...
    text(" A0. Assuming the total energy produced per fission is 200 million electron volts, equivalent to 3.2 x 10^-4 ergs, the specification gives the power relation in its printed formula [PDF p. 39 formula glyphs unresolved]. Indium-foil measurements can calibrate galvanometer 70 in terms of watts.\n\nA prototype operated at about 200 watts and was then dismantled for incorporation in the larger reactor. Its active portion was a "),
    term(
    ...
    text(" with a polar semi-axis of 309 centimeters, an equatorial semi-axis of 388 centimeters, an "),
    term(
      "effective radius",
  ...
  paragraph([
    ...
    figure(24, "Fig. 24"),
    text(". The maximum density occurs at the center and falls toward the periphery approximately as a "),
    term(
      "cosine curve",
  ...
  paragraph([
    ...
    text(". Tank 101 is cylindrical and is made of a material relatively non-corrosive at low temperatures and relatively non-absorbent to neutrons, such as aluminum or stainless steel. One suitable tank is 6 feet in diameter and 7 feet 4 inches high. It contains 136 uranium-metal rods 102, each 1.1 inches in diameter and sheathed by aluminum about .035 inch thick.\n\nThe "),
    term(
      "critical size",
    ...
    text(" further includes a cooled lead-cadmium shield 107, cover plate 108, iron and Masonite shield 109a, and a central "),
    term(
      "irradiation well",
    ...
    text(" 109b. Helium is circulated above the D2O to remove gases formed by decomposition. Rod 102 in "),
    figure(26, "Fig. 26"),
    ...
    figure(29, "Fig. 29"),
    text(" hollow cadmium control and safety rods. The described uranium-D2O reactor was operated continuously at 250 kilowatts when filled to higher levels and properly shimmed."),
  ]),
  paragraph([
    text("The following table sets forth constants for representative beryllium-uranium reactors, as presently known.\n\nBERYLLIUM METAL, DENSITY 1.85 GM./CM.3"),
  ]),
  {
    kind: "table",
    headers: [[text("")], [text("U sphere")], [text("U rod")], [text("Slab")]],
    rows: [
      [[text("Radius of uranium bodies")], [text("5.0 cm.")], [text("3.5 cm.")], [text("1.5 cm. (thickness)")]],
      [[text("Critical cylinder")], [text("165 x 309.1 cm.")], [text("165 x 304.9 cm.")], [text("79 x 343.8 cm.")]],
  ...
  paragraph([
    ...
    text(" can also be used as a moderator and closely resembles light water, giving a gain of from 2 to 4 per cent in K. With either moderator, slight enrichment of the uranium with U233, U235, or U239 will provide a K sufficiently greater than unity to enable construction of operating reactors.\n\nA water or diphenyl lattice may be used as part of a reactor, with a "),
    term(
      "seed portion",
  ...
  paragraph([
    text("Limit curves for theoretically pure natural-uranium metal spheres and rods and oxide spheres and rods are shown in "),
    figure(2, "Figs. 2, 3, 4, 5, and 6", [3, 4, 5, 6]),
    text(" for various moderators. The shapes and extents of the curves are based on K being proportional to the product of three factors: p, the probability that a fast fission neutron escapes "),
    term(
      "resonance capture",
  ...
  paragraph([
    ...
    figure(6, "Fig. 6"),
    text(" represents uranium-metal rods in a D2O moderator. Radii are plotted on the ordinates and moderator-to-uranium volume ratios on the abscissae; the parenthetical values give "),
    term(
      "unit-cell ratios",
...
const fermiPages36To42ParallelReadings: Readonly<Record<number, readonly string[]>> = {
  33: ["The page-35 continuation introduces the solid-moderator reactor and its Figures 7–21 before page 36 completes the exterior safety-rod apertures, planed graphite construction blocks, live and dead graphite, uranium cylinders and oxide pseudospheres, and reflector layers supporting the cubical lattice."],
  34: ["Page 37 gives the graphite spacing and layer dimensions, removable stringers and section, the boron-fluoride ionization chamber and galvanometer circuit in Figure 16, and the fully inserted construction rods."],
  35: ["Page 38 explains indium-foil monitoring during construction, the three-minute decay interval, saturation activity A0, the predicted fiftieth-layer critical size, doubling times, shielding, and the Figure 18–20 control mechanisms."],
  36: ["Page 39 states the short-period 10,000-kilowatt capability, the conductively cooled operating limit, the unresolved printed power formula, the 200-watt prototype dimensions, and the effective-radius plot of Figure 21."],
  37: ["Page 40 describes spherical neutron-density falloff and horizontal or vertical rod lattices in Figures 22–24."],
  38: ["Page 40 gives the uranium-D2O tank dimensions, rod sheathing, critical levels, shields, helium circulation, seals, and Figures 26–29."],
  39: ["Page 41 introduces the representative beryllium-uranium reactor constants table and preserves its beryllium-metal heading before the typed table rows."],
  41: ["Page 41 continues with the beryllium-oxide density and body-radius, critical-cylinder, and material-amount values, preserving the source's sphere and rod alternatives."],
  42: ["Page 41 explains reflector savings, light-water and diphenyl lattices, enrichment, and a higher-K seed or heavy-water center in a composite reactor."],
  44: ["Page 41 begins the resonance-capture section and explains the K proportionality factors p, f, and e used for the uranium and moderator contour curves in Figures 2–6."],
  45: ["Page 41 identifies the spherical, cylindrical-rod, and D2O contour families and states that radii and moderator-to-uranium volume ratios form the graph axes."],
  46: ["Page 42 gives the metallic-sphere radius threshold, the Figure 2 and Figure 3 limits, and the approximately 1.09 to 1.10 K contours for aggregated uranium metal."],
  47: ["Page 42 gives the uranium-oxide sphere and rod thresholds and optima in Figures 4 and 5, including their radii and moderator-to-uranium volume ratios."],
  48: ["Page 42 compares removable rods with spheres, gives the higher-K D2O rod curves in Figure 6, and states the design tradeoffs among body size, volume ratio, aggregation, enrichment, uranium, and moderator."],
};

const fermiPages43To49ParallelReadings: Readonly<Record<number, readonly string[]>> = {
  49: ["Page 43 records that the curves account only for resonance and moderator losses, so true K values for available materials must also include impurity losses."],
  51: ["Page 43 defines neutronic purity, distinguishes chemical purity from low danger sum, and gives hydrochloric-acid leaching and the stated impurity limits."],
  52: ["Page 43 describes the ether solution and repeated water extraction of uranyl nitrate, including nitric-acid treatment, crystallization, and the one-half to five per cent water proportion."],
  53: ["Page 43 continues the purification sequence from uranyl nitrate through U3O8, UO2, uranium fluorides, metal, and carbide, including the large-scale extraction arrangement."],
  54: ["Page 43 closes the purification account with calcination, hydrogen reduction, fluorination, magnesium reduction, billet casting, and machining into reactor bodies."],
  55: ["Page 44 introduces the exponential-pile and shotgun comparisons for uranium compounds and expresses impurity danger as equivalent boron absorption and K reduction."],
  56: ["Page 44 defines the ten-kilogram impurity absorption ratio and gives the 4,560-milligram boron reference and the observed 0.003 to 0.0053 K-unit danger sums."],
  57: ["Page 44 explains why graphite purity matters at the moderator-to-uranium mass ratio, gives the boron and vanadium K reduction range, and describes D2O contamination and neutron purification."],
  58: ["Page 44 states how the detector-foil comparison with a boron absorber measures impurity danger and the corresponding K reduction independently of chemical analysis."],
  60: ["Page 45 distinguishes conductive low-power cooling from circulated high-power cooling and requires coolant and pipe absorption to be included in neutronic design."],
  61: ["Page 45 itemizes the approximately 200-MeV fission-energy budget and its uranium, graphite, and external shares, then relates coolant and pipes to the moderator and fuel bodies."],
  62: ["Page 45 explains the aluminum-tube water system, its moderator-conduction limit, and why direct uranium cooling needs chemical protection and fission-fragment containment."],
  63: ["Page 45 identifies the air-cooled 3,000-kilowatt construction in Figures 31–36 and explains neutron conversion of boron and light-water impurities."],
  65: ["Page 46 describes the graphite cube, square air channels, inlet and outlet equipment, fan, stack, and thick concrete shielding in Figures 31 and 32."],
  66: ["Page 46 gives the 700-channel unity loading and 1,000-channel near-1.005 operating loading, with purity, graphite plugs, peripheral cooling, and absorber control."],
  67: ["Page 46 gives the Figure 34 fuel slug dimensions, aluminum jacket, sizing die, cap, seam weld, corrosion protection, and fission-fragment containment."],
  68: ["Page 47 states the above-critical loading ratio, seven-inch spacing, 47-to-1 volume ratio, K about 1.06, delayed-neutron doubling time, and absorber insertion behavior."],
  69: ["Page 47 describes the Figure 32 control rod, cadmium or boron absorber, shim and safety rods, melting limits, air-flow rates, and continuous operating powers."],
  70: ["Page 47 describes Figure 31 and 35 loading apertures, plugs, charging tube, plunger, elevator, staged loading, rod calibration, core uranium mass, shutdown, and delayed activity."],
  71: ["Page 47 records the post-loading fan startup, control-rod withdrawal and unity adjustment, radioactive-air exhaust, U239 production run, and delayed-neutron shutdown interval."],
  73: ["Page 48 describes underwater cooling and aging during unloading, including outlet plates, valves, coffin chamber, lead shielding, crane handling, and the thirty-day water period."],
  74: ["Page 48 identifies jacket and air-channel neutron losses, the approximately 0.005 K reduction, and the additional absorption introduced by liquid-coolant pipes."],
  75: ["Page 48 introduces the liquid-cooled reactor in Figures 37–39, describing its graphite core, reflector, steel casing, concrete tank, water and lead-shot shields, manifolds, and coolant tubes."],
  76: ["Page 48 explains the jacketed uranium slugs, recirculated water or closed diphenyl system, control and monitoring rods, and the uniform coolant annulus shown in Figure 39."],
  77: ["Page 49 quantifies the 100,000-kilowatt liquid-cooled design, including K reductions from jackets, pipes, coolant, principal active dimensions, fuel and graphite masses, annulus, rod count, and square spacing."],
  78: ["Page 49 compares diphenyl's thicker annulus and higher boiling point with its closed-circulation and polymerization costs, then limits coolant quantity by K minus 1 for graphite and D2O systems."],
  79: ["Page 49 states the design method: treat coolant and structural elements as parasitic impurities, evaluate their K reduction, and use the result to determine critical and operating sizes."],
  81: ["Page 49 introduces different lattice zones and moderators, including a D2O center or uranium-H2O surround, to obtain a practical composite operating size when one lattice has low K."],
};

const fermiPages50To58ParallelReadings: Readonly<Record<number, readonly string[]>> = {
  82: ["Page 50 explains statistical weighting for concentric lattice zones, using Fig. 40 to value material near the high-neutron-density center more heavily than material near the edge."],
  83: ["Page 50 applies Fig. 40 to three cylindrical lattice zones with separate K values and migration lengths, preserving the relation between zone sizes and the overall reproduction factor."],
  84: ["Page 50 gives the Fig. 40 example with K1 1.05, K2 1.06, weights 0.525 and 0.475, and average K about 1.0548, including the high-K and flattening effects of central zones."],
  85: ["Page 50 explains that, after neutron losses are evaluated, measured exponential-pile relaxation distance A determines critical dimensions and, with migration length M, the reproduction factor K."],
  87: ["Page 51 states that measured relaxation distance A gives critical size directly, while the relation involving (K - 1)/M and A permits critical and operating sizes without assigning every nuclear constant."],
  88: ["Page 51 explains delayed-neutron timing, the growth rates at reproduction ratios 1.001 through 1.03, and the approximately 1.005 maximum safe operating ratio."],
  89: ["Page 51 connects material buckling and migration length to critical sphere, parallelepiped, and cylinder dimensions, with Figure 30 giving D2O uranium-rod relations."],
  90: ["Page 52 records the reflector correction: returning otherwise escaping neutrons increases effective size, although the all-energy approximation remains an engineering limitation."],
  91: ["Page 52 describes control by D2O leakage or cadmium and boron rods, including fully inserted shutdown, unity reproduction, and the permitted maximum withdrawal position."],
  92: ["Page 52 explains ionization-chamber monitoring and the control-rod movements that raise, stabilize, reduce, or restore neutron density after delayed-neutron growth."],
  93: ["Page 53 describes motor-driven control rods and gravity-released safety rods, relating the one-percent reproduction limit to rod insertion time and delayed neutron response."],
  94: ["Page 53 accounts for temperature, pressure, isotope conversion, fission products, and the tellurium–iodine–xenon chain as operating changes to K."],
  95: ["Page 53 explains xenon-135's large capture cross section, its formation and removal, and why high-power sizing and rod withdrawal must include xenon reduction."],
  96: ["Page 54 quantifies equilibrium xenon reductions, shim-rod compensation, full shutdown insertion, cinch calibration, inhour period, and the pressure correction at 760 millimeters."],
  97: ["Page 54 describes intermittent low-power operation, xenon decay, cinch rod calibration, the e = 2.718 reactor period, inhour measurement, and atmospheric-pressure correction."],
  100: ["Page 54 introduces reactor uses for neutron and gamma sources, thorium-to-uranium-233 conversion, and carbon-14 production from nitrogen irradiation."],
  101: ["Page 55 describes thermal-neutron columns, collimated research beams, radiographs, neutron screens, and bismuth filtering for separating radiation components."],
  102: ["Page 55 describes removable-stringer tests of absorbers, producers, impurities, coatings, dimensions, and temperature, with corrected control-rod position measuring neutron economy."],
  103: ["Page 55 records post-irradiation recovery of U239 and fission products, steam and heat-production adaptations, and the specification's reservation for later experimental modification."],
  104: ["The page-56 claim preface introduces the eight printed claims that follow in the patent's formal claim section."],
  114: ["The United States reference is Fermi et al., U.S. Patent 2,206,634, dated July 2, 1940."],
  116: ["The foreign references preserve the Australian, Swiss, French, and Great Britain patent numbers, jurisdictions, and dates printed on page 57."],
  118: ["The other references preserve Power, Kelly et al. in Physical Review, and Flügge in Naturwissenschaften, including the copy locations printed in the patent file."],
  121: ["Page 58 identifies the United States Patent Office correction certificate, Patent No. 2,708,656, dated May 17, 1955, and Enrico Fermi et al."],
  122: ["The certificate states that errors appear in the printed specification and that the Letters Patent should read as corrected below."],
  123: ["The correction paragraph preserves every printed column and line correction, including BT to A, friction to fraction, ether-water, the K-1.005... formula correction, and CC to CS."],
  ...
  126: ["The attestation preserves E. J. Murry as Attesting Officer and Robert C. Watson as Commissioner of Patents."],
};
...
const fermiPages50To58ReconciledBlocks: readonly CuratedSpecificationBlock[] = [
  paragraph([
    text("When reactors are constructed of concentric layers, the average K can be calculated. Curves in "),
    figure(40, "Fig. 40"),
    text(
