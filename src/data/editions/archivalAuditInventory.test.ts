...
describe("server-only archival audit inventory", () => {
  test("enumerates every catalogue record and every latent strict-audit figure occurrence", () => {
    ...
    expect(inventory.summary).toMatchObject({
      ...
      acceptedRecordCount: 45,
      nonacceptedRecordCount: 58,
      primaryReasonCounts: {
        figure: 38,
        "facsimile-review": 10,
        ledger: 0,
      ...
      unacceptedFigureOccurrenceCount: 2071,
      recordsWithAttestedFiguresMissingLocators: 23,
      recordsMissingFigureAttestationsAndLocators: 27,
    });
  }, 30000);
