...
describe("server-only archival audit inventory", () => {
  test("enumerates every catalogue record and every latent strict-audit figure occurrence", () => {
    ...
    expect(inventory.summary).toMatchObject({
      ...
      acceptedRecordCount: 38,
      nonacceptedRecordCount: 65,
      primaryReasonCounts: {
        figure: 45,
        "facsimile-review": 10,
        ledger: 0,
      ...
      unacceptedFigureOccurrenceCount: 2173,
      recordsWithAttestedFiguresMissingLocators: 25,
      recordsMissingFigureAttestationsAndLocators: 30,
    });
  }, 30000);
