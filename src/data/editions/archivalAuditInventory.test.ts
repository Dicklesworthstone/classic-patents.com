...
describe("server-only archival audit inventory", () => {
  test("enumerates every catalogue record and every latent strict-audit figure occurrence", () => {
    ...
    expect(inventory.summary).toMatchObject({
      ...
      acceptedRecordCount: 50,
      nonacceptedRecordCount: 53,
      primaryReasonCounts: {
        figure: 33,
        "facsimile-review": 10,
        ledger: 0,
      ...
      unacceptedFigureOccurrenceCount: 1905,
      recordsWithAttestedFiguresMissingLocators: 22,
      recordsMissingFigureAttestationsAndLocators: 23,
    });
  }, 30000);
