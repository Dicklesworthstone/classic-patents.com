...
function term(content: string, key: string, definition: string): CuratedSpecificationInline {
...
export const maimanRubyLaserArchivalEdition: CuratedSpecificationEdition = {
  ...
  reviewedLedgerPath: "/patents/transcripts/us-3353115-maiman-ruby-laser-reviewed.txt",
  ...
  blocks: [
    ...
    },
    {
      kind: "heading",
      level: 2,
      inlines: [text("RUBY LASER SYSTEM (OPTICAL MASER APPARATUS)")],
    },
    {
      kind: "paragraph",
      inlines: [
    ...
    },
    {
      ...
      inlines: [
        text(
          "Filed Apr. 13, 1961, Ser. No. 102,698. 2 Claims. (Cl. 331—94.5). Patented Nov. 14, 1967.",
        ),
      ],
    },
    {
    ...
    },
    {
      ...
      inlines: [
        ...
        text(
          " as the active laser material. In the past, devices operating on the principles of stimulated emission of radiation were primarily confined to the microwave region of the spectrum and were commonly known as ",
        ),
        term(
          "masers",
          "maser",
        ...
        text(
          ". More recently, theoretical proposals have suggested extending these quantum amplification principles into the infrared and optical spectrum, but practical realization has encountered severe difficulties regarding pumping efficiency, crystal stability, and continuous threshold inversion.",
        ),
      ],
    },
    {
      ...
      inlines: [
        ...
        figure("FIG. 1", "1", {
          ...
          height: 733,
          caption:
            "Helical flash tube optical pumping geometry and ruby rod assembly of US Patent 3,353,115.",
        }),
        text("."),
      ],
    },
    {
      ...
      inlines: [
        ...
        figure("FIG. 2", "2", {
          ...
          height: 630,
          caption:
            "Three energy level diagram showing ground state 1, broadband pump level 3, and metastable laser level 2.",
        }),
        ...
        text(
          " (Level 1). High-intensity broadband optical pumping light in the green (560 nm) and violet (410 nm) absorption bands excites the chromium ions to the broad ",
        ),
        term(
          "third energy levels",
          "third energy levels",
    ...
    },
    {
      ...
      inlines: [
        ...
        figure("FIG. 4", "4", {
          ...
          height: 511,
          caption:
            "Cylindrical ruby laser rod with polished, mutually parallel silvered Fabry-Perot end reflectors.",
        }),
        text(
    ...
    },
    {
      ...
      inlines: [
        ...
        figure("FIG. 7", "7", {
          ...
          height: 733,
          caption:
            "Water-cooled laser head structure housing the ruby rod and helical xenon flash lamp.",
        }),
        text(
    ...
    },
    {
      ...
      inlines: [
        ...
        figure("FIG. 18", "18", {
          ...
          height: 715,
          caption:
            "Colidar laser radar ranging system block diagram utilizing ruby laser transmitter and photoelectric receiver.",
        }),
        text(
...
export const maimanRubyLaserParallelReadings: Record<number, string[]> = {
  0: [
    "Formal United States Patent Office masthead and registration of US Patent 3,353,115 granted to Theodore H. Maiman.",
  ],
  1: ["Granted title designating the ruby laser system and solid-state optical maser apparatus."],
  2: [
    "Inventor identity: Theodore H. Maiman of Pacific Palisades, California, assignor to Hughes Aircraft Company.",
  ],
  3: [
    "Official application filing date of April 13, 1961, grant date of November 14, 1967, and classification 331—94.5.",
  ],
  4: ["Specification section heading."],
  5: [
    "Background of quantum electronics: transition from microwave masers to optical wavelengths and the prior-art challenge of creating an optical resonator and pumping engine.",
  ],
  6: [
    "The core apparatus: synthetic ruby crystal rod coupled to a high-intensity helical xenon flash tube and optical Fabry-Perot resonator.",
  ],
  7: [
    "Quantum mechanical three-level system: optical absorption into broad green/violet bands (Level 3) followed by sub-microsecond non-radiative phonon relaxation to the metastable 2E state (Level 2).",
  ],
  8: [
    "Achievement of population inversion (N2 > N1) over the ground state, overcoming spontaneous emission losses to trigger coherent stimulated emission avalanche at 694.3 nm.",
  ],
  9: [
    "Fabry-Perot resonator fabrication: precision polished, parallel end faces with dielectric or silver coatings for mode selection and beam extraction.",
  ],
  10: [
    "Cooled optical cavity architecture: liquid and forced nitrogen cooling jackets to maintain ruby rod low-temperature stability during high-energy discharge cycling.",
  ],
  11: [
    "Colidar application: the world's first laser radar system utilizing monochromatic microsecond optical pulses for high-precision, jam-proof spatial ranging.",
  ],
  12: [
  ...
  14: [
    "Claim 1: The foundational apparatus combination claiming a three-energy-level ruby crystal, broadband optical pumping source, radiationless transition establishing population inversion, tuned interferometer resonator, and beam extraction coupling means.",
  ],
  15: [
    "Claim 2: The system claim protecting three-level optical pumping directly coupled to ruby, radiationless energy transition creating population inversion, and regenerative light-resonating path stimulating 694.3 nm coherent beam emission.",
  ],
};
