...
export const maimanRubyLaserArchivalEdition: CuratedSpecificationEdition = {
  ...
  blocks: [
    ...
    p(
      ...
      figure(14),
      ". In this example one of the reflective plates 172 may be placed directly on the active laser segment 174 while the other reflective plate 176 may be axially disposed at some distance from the segment 174. As shown, the nonparallel ray 178 will not be re-reflected between the two reflective plates 172 and 176 thereby minimizing its deleterious effects on the monochromatic output beam 180.",
    ),
    p(
      figure(16, "FIGS. 16"),
      " and ",
