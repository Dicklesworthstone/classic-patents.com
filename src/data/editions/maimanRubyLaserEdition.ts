...
export const maimanRubyLaserParallelReadings: Readonly<Record<number, readonly string[]>> = {
  8: [
    "The continuation statement identifies this grant as a continuation of the abandoned 1961 Laser Systems application.",
  ],
  9: [
    "Maiman defines the invention as generation, amplification, and use of coherent electromagnetic waves in infrared, visible, and ultraviolet portions of the spectrum.",
  ],
  10: [
    "The opening explains why coherent monochromatic light with waves propagating in phase would expand communications and metrology capabilities.",
  ],
  11: [
    "The specification contrasts optical wavelengths with microwave cavities: oversized cavities support many modes, degrade coherence, and demand excessive pump power.",
  ],
  12: [
    "Schawlow and Townes had proposed gaseous negative-temperature media, but the grant identifies the practical difficulty of operating such media.",
  ],
  13: [
    "The gas-laser proposal is described as complex, impurity-sensitive, and not yet demonstrated to provide net optical generation or amplification.",
  ],
  14: [
    "The listed objects call for a low-noise, mechanically stable, temperature-flexible, high-power laser and a laser-based optical radar system.",
  ],
  15: ["The invention answers those objects with a solid-state negative-temperature medium."],
  16: [
    "The representative ruby rod uses broadband pump light, reflecting end coatings, and an output opening so a resonating wave becomes a narrow monochromatic beam.",
  ],
  17: [
    "The drawing list identifies the patent's eighteen printed figures and assigns each to its source-described optical pumping, resonator, filtering, or colidar function.",
  ],
  18: [
    "The specification introduces the two-level absorption and emission model, where wave interaction depends on the difference between populations in the two levels.",
  ],
  19: [
    "A third higher level permits pumping and, with suitable relaxation times, creates an inverted population so the optical wave is emitted and amplified.",
  ],
  20: [
    "The model places the transition in the visible spectrum, allowing a material with suitable energy levels to amplify or generate visible light.",
  ],
  21: [
    "Figure 1's level 1 is the ground state and region 3 is a broad higher-energy band from which the chromium-doped material is pumped.",
  ],
  22: [
    "The preferred radiationless decay funnels broad pump energy into the narrow level 2, whose stimulated transition to level 1 emits coherent radiation.",
  ],
  23: [
    "Figure 2 follows the pump sequence in ruby rod 10: broadband light excites the dopant, relaxation populates level 2, and repeated axial reflections produce beam 16.",
  ],
  24: [
    "Figure 3 substitutes sunlight or another parallel white-light source, with lens 18 and mirror 24 concentrating and returning pump energy through active material 22.",
  ],
  25: [
    "Figure 4 places active rod 26 inside helical flash tube 28, with silvered ends, opening 32, power supply 36, and reflecting outer cylinder 38.",
  ],
  26: [
    "Figure 5 replaces the helical tube with hollow cylinder 50, flashing gas 52, electrodes 54 and 56, and a reflective pump interior around rod 40.",
  ],
  27: [
    "Figure 6 adds fluorescein 64 between rod 60 and flash tube 62, converting broadband white pump light 66 into green light for the ruby, as represented by Figure 7.",
  ],
  28: [
    "Figure 8 uses hollow active cylinder 70 around flash tube 72 and surrounds it with coolant cylinder 74 containing coolant 76.",
  ],
  29: [
    "Figure 9 refrigerates rod 78 near liquid nitrogen 90, with conductive rod 88, Dewar flask 92, flash tube 94, electrodes 98, and coolant 102.",
  ],
  30: [
    "Figure 10 distinguishes axial ray 106 from nonparallel rays 108 and 112 whose reflections lengthen the resonator and degrade frequency purity and beam coherence.",
  ],
  32: [
    "The formal claims that follow the specification define the three-level ruby medium, broadband optical pumping, population inversion, regenerative resonant path, and monochromatic output as the protected combinations.",
  ],
  36: [
    "The references cited identify Schawlow and Townes's United States patent and the two printed optical-maser publications, preserving the grant's research trail.",
  ],
  ...
  39: [
    "The inventor and attorney signature lines are retained as source-formal matter, without treating the typed ledger as a substitute for the facsimile pixels.",
  ],
  40: [
    "The examiner names and cited works close the typed formal record while the pinned facsimile remains the authority for exact visual placement and signatures.",
  ],
  41: [
    "The closing signature block preserves Theodore H. Maiman as inventor and Daniel T. Chubb as attorney, while its visual inscription remains tied to the facsimile.",
  ],
};
  ...
  blocks: [
    ...
    },
    {
      ...
      description: [
        ...
        ref("FIG. 1", "#figure-1", "Figure 1"),
        text("; "),
        ref("FIG. 2", "#figure-2", "Figure 2"),
        text("; "),
        ref("FIG. 3", "#figure-3", "Figure 3"),
    ...
    },
    {
      ...
      description: [
        ...
        ref("FIG. 4", "#figure-4", "Figure 4"),
        text("; "),
        ref("FIG. 5", "#figure-5", "Figure 5"),
        text("; "),
        ref("FIG. 6", "#figure-6", "Figure 6"),
        text("; "),
    ...
    },
    {
      ...
      description: [
        ...
        ref("FIG. 8", "#figure-8", "Figure 8"),
        text("; "),
        ref("FIG. 9", "#figure-9", "Figure 9"),
        text("; "),
        ref("FIG. 10", "#figure-10", "Figure 10"),
        text("; "),
        ref("FIG. 11", "#figure-11", "Figure 11"),
        text(". Inventor Theodore H. Maiman; attorney Daniel T. Chubb."),
      ],
    },
    {
      ...
      description: [
        ...
        text("; "),
        ref("FIGS. 14 and 15", "#figure-14", "Figures 14 and 15"),
        text(". Inventor Theodore H. Maiman; attorney Daniel T. Chubb."),
      ],
    },
    {
      ...
      description: [
        ...
        ref("FIGS. 16 and 17", "#figure-16", "Figures 16 and 17"),
        text("; "),
    ...
    p(
      ...
      term(
        "laser",
        "The source's acronym for light amplification by stimulated emission of radiation.",
      ),
      text(
    ...
    p(
      ...
      ref("FIG. 5", "#figure-5", "Figure 5"),
      text(" is a diagram of an alternative embodiment utilizing a hollow gas-filled cylinder; "),
      ref("FIG. 6", "#figure-6", "Figure 6"),
      text(
    ...
    p(
      ...
      text(
        " is an energy level diagram illustrating the method of operation of the embodiment of FIG. 6; ",
      ),
      ref("FIG. 8", "#figure-8", "Figure 8"),
      text(
      ...
      ref("FIG. 9", "#figure-9", "Figure 9"),
      text(" is a cut-away view of an embodiment in which the laser material is refrigerated; "),
      ref("FIG. 10", "#figure-10", "Figure 10"),
      text(" is a diagram of a segment of laser material; "),
      ref("FIG. 11", "#figure-11", "Figure 11"),
      text(" is a diagram of a coated segment of laser material;"),
    ),
    p(
      ref("FIG. 12", "#figure-12", "Figure 12"),
      text(
      ...
      ref("FIGS. 14 and 15", "#figure-14", "Figures 14 and 15"),
      text(" are schematic diagrams illustrating additional types of interferometers; "),
      ref("FIGS. 16 and 17", "#figure-16", "Figures 16 and 17"),
      text(
      ...
      text(" is a schematic diagram of a practical colidar system utilizing a laser."),
    ),
    p(
      text(
