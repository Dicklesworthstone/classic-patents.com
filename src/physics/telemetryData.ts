      ...
      return [
        {
          ...
          unit: "v_ship",
          badgeColor: "cyan",
          progressPct: clampProgress((Number(speedKnots) / 22) * 100),
        },
        {
          label: "Axial Thrust",
          value: `${thrustKn} kN`,
          unit: "T_prop",
          badgeColor: "emerald",
          progressPct: clampProgress((thrustKn / 90) * 100),
        },
        {
          label: "Shaft ω",
        ...
        },
        {
          ...
          unit: "p",
          badgeColor: "amber",
          progressPct: clampProgress((ericson.pitchMeters / 5) * 100),
        },
        {
          label: "Apparent Slip",
          ...
          unit: "s",
          badgeColor: "purple",
          progressPct: clampProgress(ericson.slipFraction * 100),
        },
      ];
    },
    pedagogicalInsight:
