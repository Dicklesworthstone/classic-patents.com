...
export function DeLavalSeparatorSim() {
  ...
  return (
    ...
    >
      <SimulationHeader
        icon={<Disc className="h-5 w-5 text-amber-600 dark:text-amber-400" />}
        title="Gustaf de Laval Continuous Centrifugal Cream Separator (US 247,804)"
        description="High-G artificial gravity (4,000+ G), concentric fluid density stratification, and dual spout discharge."
        playbackAction={{
