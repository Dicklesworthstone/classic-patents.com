...
import { MousePointer, Move, RotateCcw, Sparkles, Volume2, VolumeX } from "lucide-react";
...
export function EngelbartMouseSim() {
  const { params, updateParam, resetParams } = usePatentPhysics("us-3541541-engelbart-mouse");
