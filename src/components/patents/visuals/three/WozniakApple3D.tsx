            ...
            <div className="grid grid-cols-3 gap-1 pt-0.5">
              {[4, 16, 48].map((kb) => (
                <button
                  ...
                  className={`py-1.5 rounded-lg text-xs font-semibold border font-mono transition-colors ${
                    ramCapacityKb === kb
          ...
          <div className="flex items-center gap-2">
            ...
            {(["hires_color", "lores_color", "text_40col"] as const).map((mode) => (
              <button
                ...
                className={`px-3 py-1 rounded-lg font-sans font-semibold capitalize transition-colors ${
                  videoMode === mode
