  ...
  return (
    <section className="overflow-hidden rounded-2xl border border-slate-700 bg-slate-950 shadow-2xl">
      <div className="relative min-h-[420px] sm:min-h-[520px]">
        ...
        <div className="absolute bottom-3 left-3 right-3 grid gap-2 rounded-xl border border-slate-700/80 bg-slate-950/88 p-3 backdrop-blur sm:bottom-5 sm:left-5 sm:right-5 sm:grid-cols-[1fr_auto]">
