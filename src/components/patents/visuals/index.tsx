    ...
    <div className="space-y-4">
      ...
      {has3DMode && (
        <div className="flex justify-end">
          <div className="flex items-center gap-1 bg-parchment-200 dark:bg-ink-900 p-1 rounded-xl border border-parchment-300 dark:border-ink-800 text-xs font-mono shadow-sm">
            <button
              type="button"
              ...
              className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg transition-all ${
                renderMode === "3d-physics"
                  ...
                  : "text-ink-700 dark:text-parchment-300 hover:text-ink-950"
              }`}
            >
              <Box className="w-3.5 h-3.5" />
              <span>3D WebGL Physics Mode</span>
            </button>
            <button
              type="button"
            ...
            >
              ...
              <span>2D Vector Cross-Section</span>
            </button>
          </div>
        </div>
      )}
