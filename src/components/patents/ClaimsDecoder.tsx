      ...
      <div className="flex flex-wrap gap-2.5">
        {claims.map((c) => (
          <button
            ...
            className={`px-4 py-2 rounded-xl text-xs sm:text-sm font-mono font-semibold transition-all border shadow-xs ${
          ...
          >
            <div className="flex flex-wrap items-center justify-between gap-3 border-b border-parchment-200 dark:border-ink-800 pb-4">
              <div className="flex items-center gap-3">
                <span className="px-3 py-1 rounded-lg bg-amber-100 dark:bg-amber-950/80 text-amber-900 dark:text-amber-300 font-mono text-sm font-bold border border-amber-300 dark:border-amber-700 shadow-2xs">
                  Claim #{claim.number}
                </span>
                <span className="text-sm font-mono text-ink-600 dark:text-ink-400 font-medium">
                  {claim.isIndependent
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="space-y-2.5">
                <div className="flex items-center gap-2 text-xs sm:text-sm font-mono font-bold text-ink-800 dark:text-parchment-300 uppercase tracking-wider">
                  <BookOpen className="w-4 h-4 text-amber-700 dark:text-amber-400" />
                  Verbatim Historical Legal Text
                </div>
                <div className="p-5 rounded-xl bg-parchment-100/80 dark:bg-ink-900/80 border border-parchment-200 dark:border-ink-800 text-sm sm:text-base font-mono text-ink-900 dark:text-parchment-100 leading-relaxed italic shadow-xs">
              ...
              <div className="space-y-2.5">
                <div className="flex items-center gap-2 text-xs sm:text-sm font-mono font-bold text-emerald-800 dark:text-emerald-400 uppercase tracking-wider">
                  <Sparkles className="w-4 h-4" />
                  Plain English Engineering Translation
                </div>
                <div className="p-5 rounded-xl bg-emerald-50/70 dark:bg-emerald-950/30 border border-emerald-200 dark:border-emerald-800/60 text-sm sm:text-base text-ink-950 dark:text-emerald-100 leading-relaxed font-sans font-medium shadow-xs">
                  {claim.plainEnglish}
                </div>
              </div>
            </div>
            ...
            <div className="pt-2 grid grid-cols-1 md:grid-cols-2 gap-5 text-sm font-mono">
