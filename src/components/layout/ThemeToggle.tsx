  ...
  return (
    ...
    >
      <div className="relative w-5 h-5 flex items-center justify-center">
        ...
        <Sun
          className={`w-5 h-5 text-amber-600 dark:text-amber-400 absolute transition-all duration-500 transform ${
