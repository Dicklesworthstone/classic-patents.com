...
export function ThemeToggle() {
  ...
  return (
    <button
      type="button"
      onClick={toggleTheme}
      className="relative p-3 rounded-xl bg-white dark:bg-ink-900 border border-parchment-300 dark:border-ink-700 text-ink-700 dark:text-parchment-200 hover:text-amber-600 dark:hover:text-amber-400 hover:border-amber-400 dark:hover:border-amber-500/50 shadow-sm transition-colors duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-500/40 group overflow-hidden cursor-pointer"
    ...
    >
      <div className="relative w-5 h-5 flex items-center justify-center">
        ...
        <Sun
          className={`w-5 h-5 text-amber-600 dark:text-amber-400 absolute transition-[transform,opacity] duration-500 ${
        ...
        <Moon
          className={`w-5 h-5 text-blue-400 absolute transition-[transform,opacity] duration-500 ${
