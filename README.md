...
1. **Reviewed Archival Editions & Embedded PDFs**: Continuous hand-authored source faces and reviewed ledgers alongside pinned public-record facsimiles. Coverage is explicit: 89 of 102 catalogue records currently publish the reviewed edition contract; thirteen stored, withdrawn, or missing editions remain fail-closed pending full-facsimile acceptance.
