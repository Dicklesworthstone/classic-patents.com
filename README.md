...
1. **Reviewed Archival Editions & Embedded PDFs**: Continuous hand-authored source faces and reviewed ledgers alongside pinned public-record facsimiles. Coverage is explicit: 77 of 91 catalogue records currently publish the reviewed edition contract; fourteen stored, withdrawn, or missing editions remain fail-closed pending full-facsimile acceptance.
...
## Curated Historical Patents (28 Highlighted — 91 in the Live Catalogue)

The live, searchable catalogue at [classic-patents.com](https://classic-patents.com) holds 91 records. All 91 have pinned facsimiles, explicit interactive-visual routes, default TypeScript telemetry owners, and live equation sets; 88 have reviewed ledgers. **77 of 91** currently cross the reviewed-edition publication boundary. Eleven records store editions whose own `completeFacsimileReviewed` attestation is false; Arkwright and Linotype have no bound edition, and Stackhouse remains on a source-bounded public shell after its draft edition and ledger were withdrawn for re-review against the pinned facsimile. `us-313224-mergenthaler-linotype` remains on its pinned facsimile, source-PDF text layer, 70 staged claim nodes, and source-bounded editorial face after its ledger/draft failed independent acceptance against the pinned 17-sheet facsimile. This table highlights 27 foundational entries; search (⌘K) and the timeline cover the full registry.
...
│  • 91/91 typed-host default owners with explicit live equations        │
│  • 3 patent-specific + 0 interpretive + 40 generic WASM surfaces       │
│  • 47 ticking bus updaters + 44 typed snapshot publishers              │
